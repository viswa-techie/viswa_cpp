# Chapter: Template specialization for class
...
## 1. Problem Statement
Master the topic: **Template specialization for class**.
...
This problem exercises **Template specialization for class** — a core concept in OOP — Classes & Objects.
...
Think of **Template specialization for class** as a blueprint (class) producing instances (objects) sharing behavior via a vtable.
...
#include <vector>
#include <string>
// Brute-force template for: Template specialization for class
int solve_template_specialization_for_class(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_template_specialization_for_class(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Template specialization for class
int solve_template_specialization_for_class(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Template specialization for class
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Template specialization for class — model real-world entities with state + behavior.
