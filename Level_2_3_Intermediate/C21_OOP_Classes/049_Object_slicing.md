...
## 1. Problem Statement
Master the topic: **Object slicing**.
...
Copying a Derived into a Base value loses derived data and overrides.
...
Think of **Object slicing** as a blueprint (class) producing instances (objects) sharing behavior via a vtable.
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Object slicing
int main() {
...
- **Core idea:** Object slicing — model real-world entities with state + behavior.
