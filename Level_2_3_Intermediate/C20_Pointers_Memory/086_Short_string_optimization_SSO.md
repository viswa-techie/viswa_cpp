# Chapter: Short string optimization SSO
...
## 1. Problem Statement
Master the topic: **Short string optimization SSO**.
...
This problem exercises **Short string optimization SSO** — a core concept in Pointers & Memory Management.
...
Think of **Short string optimization SSO** as an arrow pointing to a memory cell — the arrow itself lives in a variable.
...
#include <vector>
#include <string>
// Brute-force template for: Short string optimization SSO
int solve_short_string_optimization_sso(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_short_string_optimization_sso(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Short string optimization SSO
int solve_short_string_optimization_sso(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Short string optimization SSO
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Short string optimization SSO — manage who owns the memory.
