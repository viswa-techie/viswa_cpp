...
## 1. Problem Statement
Master the topic: **Address-of operator &**.
...
Think of **Address-of operator &** as an arrow pointing to a memory cell — the arrow itself lives in a variable.
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Address-of operator &
int main() {
...
- **Core idea:** Address-of operator & — manage who owns the memory.
