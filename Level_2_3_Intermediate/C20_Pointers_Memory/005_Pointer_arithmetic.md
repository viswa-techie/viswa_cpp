...
## 1. Problem Statement
Master the topic: **Pointer arithmetic**.
...
Think of **Pointer arithmetic** as an arrow pointing to a memory cell — the arrow itself lives in a variable.
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Pointer arithmetic
int main() {
...
- **Core idea:** Pointer arithmetic — manage who owns the memory.
