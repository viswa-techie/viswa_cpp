...
This problem exercises **Object pools** — a core concept in Pointers & Memory Management.
...
Think of **Object pools** as an arrow pointing to a memory cell — the arrow itself lives in a variable.
...
#include <vector>
#include <string>
// Brute-force template for: Object pools
int solve_object_pools(std::vector<int> v) {
    int result = 0;
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Object pools
int solve_object_pools(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Object pools
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Object pools — manage who owns the memory.
