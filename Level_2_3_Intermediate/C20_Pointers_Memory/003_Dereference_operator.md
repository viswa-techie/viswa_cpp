...
## 1. Problem Statement
Master the topic: **Dereference operator ***.
...
Think of **Dereference operator *** as an arrow pointing to a memory cell — the arrow itself lives in a variable.
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Dereference operator *
int main() {
...
- **Core idea:** Dereference operator * — manage who owns the memory.
