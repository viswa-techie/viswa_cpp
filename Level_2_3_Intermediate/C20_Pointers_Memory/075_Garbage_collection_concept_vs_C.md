# Chapter: Garbage collection concept vs C++
...
## 1. Problem Statement
Master the topic: **Garbage collection concept vs C++**.
...
This problem exercises **Garbage collection concept vs C++** — a core concept in Pointers & Memory Management.
...
Think of **Garbage collection concept vs C++** as an arrow pointing to a memory cell — the arrow itself lives in a variable.
...
#include <vector>
#include <string>
// Brute-force template for: Garbage collection concept vs C++
int solve_garbage_collection_concept_vs_c__(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_garbage_collection_concept_vs_c__(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Garbage collection concept vs C++
int solve_garbage_collection_concept_vs_c__(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Garbage collection concept vs C++
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Garbage collection concept vs C++ — manage who owns the memory.
