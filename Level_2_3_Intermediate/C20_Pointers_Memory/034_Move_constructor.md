...
## 1. Problem Statement
Master the topic: **Move constructor**.
...
Steal resources from a source rvalue, leaving it in a valid empty state.
...
Think of **Move constructor** as an arrow pointing to a memory cell — the arrow itself lives in a variable.
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Move constructor
int main() {
...
- **Core idea:** Move constructor — manage who owns the memory.
