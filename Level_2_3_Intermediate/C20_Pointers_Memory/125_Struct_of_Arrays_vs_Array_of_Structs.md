# Chapter: Struct of Arrays vs Array of Structs
...
## 1. Problem Statement
Master the topic: **Struct of Arrays vs Array of Structs**.
...
This problem exercises **Struct of Arrays vs Array of Structs** — a core concept in Pointers & Memory Management.
...
Think of **Struct of Arrays vs Array of Structs** as an arrow pointing to a memory cell — the arrow itself lives in a variable.
...
#include <vector>
#include <string>
// Brute-force template for: Struct of Arrays vs Array of Structs
int solve_struct_of_arrays_vs_array_of_structs(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_struct_of_arrays_vs_array_of_structs(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Struct of Arrays vs Array of Structs
int solve_struct_of_arrays_vs_array_of_structs(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Struct of Arrays vs Array of Structs
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Struct of Arrays vs Array of Structs — manage who owns the memory.
