...
## 1. Problem Statement
Master the topic: **Null pointer (nullptr)**.
...
Think of **Null pointer (nullptr)** as an arrow pointing to a memory cell — the arrow itself lives in a variable.
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Null pointer (nullptr)
int main() {
...
- **Core idea:** Null pointer (nullptr) — manage who owns the memory.
