# Chapter: Pointer declaration & initialization
...
## 1. Problem Statement
Master the topic: **Pointer declaration & initialization**.
...
Think of **Pointer declaration & initialization** as an arrow pointing to a memory cell — the arrow itself lives in a variable.
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Pointer declaration & initialization
int main() {
...
- **Core idea:** Pointer declaration & initialization — manage who owns the memory.
