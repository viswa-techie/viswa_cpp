# Chapter: std greater void transparent
...
## 1. Problem Statement
Master the topic: **std greater void transparent**.
...
This problem exercises **std greater void transparent** — a core concept in STL Containers & Iterators.
...
Think of **std greater void transparent** as a toolbox of pre-built containers, each with specific complexity guarantees.
...
#include <vector>
#include <string>
// Brute-force template for: std greater void transparent
int solve_std_greater_void_transparent(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_std_greater_void_transparent(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: std greater void transparent
int solve_std_greater_void_transparent(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: std greater void transparent
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** std greater void transparent — reuse battle-tested containers and algorithms.
