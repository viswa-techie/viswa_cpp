# Chapter: Range-based for with iterators
...
## 1. Problem Statement
Master the topic: **Range-based for with iterators**.
...
This problem exercises **Range-based for with iterators** — a core concept in STL Containers & Iterators.
...
Think of **Range-based for with iterators** as a toolbox of pre-built containers, each with specific complexity guarantees.
...
#include <vector>
#include <string>
// Brute-force template for: Range-based for with iterators
int solve_range_based_for_with_iterators(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_range_based_for_with_iterators(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Range-based for with iterators
int solve_range_based_for_with_iterators(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Range-based for with iterators
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Range-based for with iterators — reuse battle-tested containers and algorithms.
