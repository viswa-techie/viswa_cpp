# Chapter: std set_union intersection difference
...
## 1. Problem Statement
Master the topic: **std set_union intersection difference**.
...
This problem exercises **std set_union intersection difference** — a core concept in STL Containers & Iterators.
...
Think of **std set_union intersection difference** as a toolbox of pre-built containers, each with specific complexity guarantees.
...
#include <vector>
#include <string>
// Brute-force template for: std set_union intersection difference
int solve_std_set_union_intersection_difference(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_std_set_union_intersection_difference(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: std set_union intersection difference
int solve_std_set_union_intersection_difference(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: std set_union intersection difference
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** std set_union intersection difference — reuse battle-tested containers and algorithms.
