# Chapter: Iterator adaptor back_inserter
...
## 1. Problem Statement
Master the topic: **Iterator adaptor back_inserter**.
...
This problem exercises **Iterator adaptor back_inserter** — a core concept in STL Containers & Iterators.
...
Think of **Iterator adaptor back_inserter** as a toolbox of pre-built containers, each with specific complexity guarantees.
...
#include <vector>
#include <string>
// Brute-force template for: Iterator adaptor back_inserter
int solve_iterator_adaptor_back_inserter(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_iterator_adaptor_back_inserter(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Iterator adaptor back_inserter
int solve_iterator_adaptor_back_inserter(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Iterator adaptor back_inserter
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Iterator adaptor back_inserter — reuse battle-tested containers and algorithms.
