# Chapter: std min_element max_element
...
## 1. Problem Statement
Master the topic: **std min_element max_element**.
...
This problem exercises **std min_element max_element** — a core concept in STL Containers & Iterators.
...
Think of **std min_element max_element** as a toolbox of pre-built containers, each with specific complexity guarantees.
...
#include <vector>
#include <string>
// Brute-force template for: std min_element max_element
int solve_std_min_element_max_element(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_std_min_element_max_element(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: std min_element max_element
int solve_std_min_element_max_element(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: std min_element max_element
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** std min_element max_element — reuse battle-tested containers and algorithms.
