# Chapter: Open addressing vs chaining
...
## 1. Problem Statement
Master the topic: **Open addressing vs chaining**.
...
This problem exercises **Open addressing vs chaining** — a core concept in STL Containers & Iterators.
...
Think of **Open addressing vs chaining** as a toolbox of pre-built containers, each with specific complexity guarantees.
...
#include <vector>
#include <string>
// Brute-force template for: Open addressing vs chaining
int solve_open_addressing_vs_chaining(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_open_addressing_vs_chaining(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Open addressing vs chaining
int solve_open_addressing_vs_chaining(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Open addressing vs chaining
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Open addressing vs chaining — reuse battle-tested containers and algorithms.
