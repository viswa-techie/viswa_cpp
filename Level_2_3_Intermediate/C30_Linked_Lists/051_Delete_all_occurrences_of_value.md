# Chapter: Delete all occurrences of value
...
## 1. Problem Statement
Master the topic: **Delete all occurrences of value**.
...
This problem exercises **Delete all occurrences of value** — a core concept in Linked Lists.
...
Think of **Delete all occurrences of value** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Delete all occurrences of value
int solve_delete_all_occurrences_of_value(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_delete_all_occurrences_of_value(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Delete all occurrences of value
int solve_delete_all_occurrences_of_value(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Delete all occurrences of value
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Delete all occurrences of value — chain of nodes via pointers.
