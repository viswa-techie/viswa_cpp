# Chapter: Cache-unfriendly nature of lists
...
## 1. Problem Statement
Master the topic: **Cache-unfriendly nature of lists**.
...
This problem exercises **Cache-unfriendly nature of lists** — a core concept in Linked Lists.
...
Think of **Cache-unfriendly nature of lists** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Cache-unfriendly nature of lists
int solve_cache_unfriendly_nature_of_lists(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_cache_unfriendly_nature_of_lists(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Cache-unfriendly nature of lists
int solve_cache_unfriendly_nature_of_lists(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Cache-unfriendly nature of lists
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Cache-unfriendly nature of lists — chain of nodes via pointers.
