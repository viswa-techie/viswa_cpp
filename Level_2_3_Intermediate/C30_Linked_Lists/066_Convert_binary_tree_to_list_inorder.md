# Chapter: Convert binary tree to list inorder
...
## 1. Problem Statement
Master the topic: **Convert binary tree to list inorder**.
...
This problem exercises **Convert binary tree to list inorder** — a core concept in Linked Lists.
...
Think of **Convert binary tree to list inorder** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Convert binary tree to list inorder
int solve_convert_binary_tree_to_list_inorder(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_convert_binary_tree_to_list_inorder(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Convert binary tree to list inorder
int solve_convert_binary_tree_to_list_inorder(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Convert binary tree to list inorder
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Convert binary tree to list inorder — chain of nodes via pointers.
