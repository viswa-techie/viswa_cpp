# Chapter: Remove nodes with greater right value
...
## 1. Problem Statement
Master the topic: **Remove nodes with greater right value**.
...
This problem exercises **Remove nodes with greater right value** — a core concept in Linked Lists.
...
Think of **Remove nodes with greater right value** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Remove nodes with greater right value
int solve_remove_nodes_with_greater_right_value(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_remove_nodes_with_greater_right_value(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Remove nodes with greater right value
int solve_remove_nodes_with_greater_right_value(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Remove nodes with greater right value
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Remove nodes with greater right value — chain of nodes via pointers.
