# Chapter: List from array array from list
...
## 1. Problem Statement
Master the topic: **List from array array from list**.
...
This problem exercises **List from array array from list** — a core concept in Linked Lists.
...
Think of **List from array array from list** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: List from array array from list
int solve_list_from_array_array_from_list(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_list_from_array_array_from_list(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: List from array array from list
int solve_list_from_array_array_from_list(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: List from array array from list
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** List from array array from list — chain of nodes via pointers.
