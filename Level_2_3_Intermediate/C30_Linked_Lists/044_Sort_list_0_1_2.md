...
## 1. Problem Statement
Master the topic: **Sort list 0 1 2**.
...
This problem exercises **Sort list 0 1 2** — a core concept in Linked Lists.
...
Think of **Sort list 0 1 2** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Sort list 0 1 2
int solve_sort_list_0_1_2(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_sort_list_0_1_2(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Sort list 0 1 2
int solve_sort_list_0_1_2(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Sort list 0 1 2
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Sort list 0 1 2 — chain of nodes via pointers.
