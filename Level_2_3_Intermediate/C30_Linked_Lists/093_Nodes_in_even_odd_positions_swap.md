# Chapter: Nodes in even odd positions swap
...
## 1. Problem Statement
Master the topic: **Nodes in even odd positions swap**.
...
This problem exercises **Nodes in even odd positions swap** — a core concept in Linked Lists.
...
Think of **Nodes in even odd positions swap** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Nodes in even odd positions swap
int solve_nodes_in_even_odd_positions_swap(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_nodes_in_even_odd_positions_swap(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Nodes in even odd positions swap
int solve_nodes_in_even_odd_positions_swap(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Nodes in even odd positions swap
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Nodes in even odd positions swap — chain of nodes via pointers.
