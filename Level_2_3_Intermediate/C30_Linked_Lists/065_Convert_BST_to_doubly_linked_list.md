# Chapter: Convert BST to doubly linked list
...
## 1. Problem Statement
Master the topic: **Convert BST to doubly linked list**.
...
This problem exercises **Convert BST to doubly linked list** — a core concept in Linked Lists.
...
Think of **Convert BST to doubly linked list** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Convert BST to doubly linked list
int solve_convert_bst_to_doubly_linked_list(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_convert_bst_to_doubly_linked_list(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Convert BST to doubly linked list
int solve_convert_bst_to_doubly_linked_list(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Convert BST to doubly linked list
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Convert BST to doubly linked list — chain of nodes via pointers.
