# Chapter: Sum of nodes between zeros
...
## 1. Problem Statement
Master the topic: **Sum of nodes between zeros**.
...
This problem exercises **Sum of nodes between zeros** — a core concept in Linked Lists.
...
Think of **Sum of nodes between zeros** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Sum of nodes between zeros
int solve_sum_of_nodes_between_zeros(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_sum_of_nodes_between_zeros(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Sum of nodes between zeros
int solve_sum_of_nodes_between_zeros(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Sum of nodes between zeros
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Sum of nodes between zeros — chain of nodes via pointers.
