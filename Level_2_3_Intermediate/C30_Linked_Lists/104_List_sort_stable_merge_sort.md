# Chapter: List sort stable merge sort
...
## 1. Problem Statement
Master the topic: **List sort stable merge sort**.
...
This problem exercises **List sort stable merge sort** — a core concept in Linked Lists.
...
Think of **List sort stable merge sort** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: List sort stable merge sort
int solve_list_sort_stable_merge_sort(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_list_sort_stable_merge_sort(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: List sort stable merge sort
int solve_list_sort_stable_merge_sort(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: List sort stable merge sort
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** List sort stable merge sort — chain of nodes via pointers.
