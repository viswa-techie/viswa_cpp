# Chapter: Fast-slow pointer applications
...
## 1. Problem Statement
Master the topic: **Fast-slow pointer applications**.
...
This problem exercises **Fast-slow pointer applications** — a core concept in Linked Lists.
...
Think of **Fast-slow pointer applications** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Fast-slow pointer applications
int solve_fast_slow_pointer_applications(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_fast_slow_pointer_applications(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Fast-slow pointer applications
int solve_fast_slow_pointer_applications(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Fast-slow pointer applications
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Fast-slow pointer applications — chain of nodes via pointers.
