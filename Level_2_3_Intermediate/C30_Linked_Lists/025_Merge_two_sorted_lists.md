...
## 1. Problem Statement
Master the topic: **Merge two sorted lists**.
...
Use a dummy head. Walk both lists, attach smaller node to tail.
...
Think of **Merge two sorted lists** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Merge two sorted lists
int main() {
...
- **Core idea:** Merge two sorted lists — chain of nodes via pointers.
