# Chapter: LRU Cache implementation
...
## 1. Problem Statement
Master the topic: **LRU Cache implementation**.
...
Hash map + doubly linked list. Map: key -> list iterator. List: most-recent at front.
...
Think of **LRU Cache implementation** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: LRU Cache implementation
int main() {
...
- **Core idea:** LRU Cache implementation — chain of nodes via pointers.
