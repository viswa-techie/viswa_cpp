# Chapter: Delete all duplicates keep unique
...
## 1. Problem Statement
Master the topic: **Delete all duplicates keep unique**.
...
This problem exercises **Delete all duplicates keep unique** — a core concept in Linked Lists.
...
Think of **Delete all duplicates keep unique** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Delete all duplicates keep unique
int solve_delete_all_duplicates_keep_unique(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_delete_all_duplicates_keep_unique(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Delete all duplicates keep unique
int solve_delete_all_duplicates_keep_unique(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Delete all duplicates keep unique
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Delete all duplicates keep unique — chain of nodes via pointers.
