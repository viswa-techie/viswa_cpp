# Chapter: Flatten sorted doubly nested list
...
## 1. Problem Statement
Master the topic: **Flatten sorted doubly nested list**.
...
This problem exercises **Flatten sorted doubly nested list** — a core concept in Linked Lists.
...
Think of **Flatten sorted doubly nested list** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Flatten sorted doubly nested list
int solve_flatten_sorted_doubly_nested_list(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_flatten_sorted_doubly_nested_list(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Flatten sorted doubly nested list
int solve_flatten_sorted_doubly_nested_list(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Flatten sorted doubly nested list
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Flatten sorted doubly nested list — chain of nodes via pointers.
