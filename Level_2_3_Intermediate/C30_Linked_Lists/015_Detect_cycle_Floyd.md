...
## 1. Problem Statement
Master the topic: **Detect cycle Floyd**.
...
Floyd's tortoise & hare: slow moves 1 step, fast moves 2; if they meet, cycle exists.
...
Think of **Detect cycle Floyd** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Detect cycle Floyd
int main() {
...
- **Core idea:** Detect cycle Floyd — chain of nodes via pointers.
