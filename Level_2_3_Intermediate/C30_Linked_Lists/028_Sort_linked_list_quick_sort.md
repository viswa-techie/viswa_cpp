# Chapter: Sort linked list quick sort
...
## 1. Problem Statement
Master the topic: **Sort linked list quick sort**.
...
This problem exercises **Sort linked list quick sort** — a core concept in Linked Lists.
...
Think of **Sort linked list quick sort** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Sort linked list quick sort
int solve_sort_linked_list_quick_sort(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_sort_linked_list_quick_sort(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Sort linked list quick sort
int solve_sort_linked_list_quick_sort(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Sort linked list quick sort
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Sort linked list quick sort — chain of nodes via pointers.
