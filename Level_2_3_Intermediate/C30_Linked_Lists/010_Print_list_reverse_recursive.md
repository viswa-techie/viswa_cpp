# Chapter: Print list reverse recursive
...
## 1. Problem Statement
Master the topic: **Print list reverse recursive**.
...
This problem exercises **Print list reverse recursive** — a core concept in Linked Lists.
...
Think of **Print list reverse recursive** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Print list reverse recursive
int solve_print_list_reverse_recursive(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_print_list_reverse_recursive(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Print list reverse recursive
int solve_print_list_reverse_recursive(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Print list reverse recursive
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Print list reverse recursive — chain of nodes via pointers.
