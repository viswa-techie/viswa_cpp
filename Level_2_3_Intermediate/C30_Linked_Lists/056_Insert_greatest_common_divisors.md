# Chapter: Insert greatest common divisors
...
## 1. Problem Statement
Master the topic: **Insert greatest common divisors**.
...
This problem exercises **Insert greatest common divisors** — a core concept in Linked Lists.
...
Think of **Insert greatest common divisors** as a chain of train cars, each holding cargo and a coupling to the next.
...
#include <vector>
#include <string>
// Brute-force template for: Insert greatest common divisors
int solve_insert_greatest_common_divisors(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_insert_greatest_common_divisors(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Insert greatest common divisors
int solve_insert_greatest_common_divisors(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Insert greatest common divisors
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Insert greatest common divisors — chain of nodes via pointers.
