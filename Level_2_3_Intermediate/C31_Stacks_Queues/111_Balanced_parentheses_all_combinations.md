# Chapter: Balanced parentheses all combinations
...
## 1. Problem Statement
Master the topic: **Balanced parentheses all combinations**.
...
This problem exercises **Balanced parentheses all combinations** — a core concept in Stacks & Queues.
...
Think of **Balanced parentheses all combinations** as a stack of plates (LIFO) or a coffee-shop queue (FIFO).
...
#include <vector>
#include <string>
// Brute-force template for: Balanced parentheses all combinations
int solve_balanced_parentheses_all_combinations(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_balanced_parentheses_all_combinations(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Balanced parentheses all combinations
int solve_balanced_parentheses_all_combinations(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Balanced parentheses all combinations
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Balanced parentheses all combinations — order-of-arrival/departure matters.
