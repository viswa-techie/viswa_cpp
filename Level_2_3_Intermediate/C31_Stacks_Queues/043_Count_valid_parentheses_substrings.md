# Chapter: Count valid parentheses substrings
...
## 1. Problem Statement
Master the topic: **Count valid parentheses substrings**.
...
This problem exercises **Count valid parentheses substrings** — a core concept in Stacks & Queues.
...
Think of **Count valid parentheses substrings** as a stack of plates (LIFO) or a coffee-shop queue (FIFO).
...
#include <vector>
#include <string>
// Brute-force template for: Count valid parentheses substrings
int solve_count_valid_parentheses_substrings(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_count_valid_parentheses_substrings(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Count valid parentheses substrings
int solve_count_valid_parentheses_substrings(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Count valid parentheses substrings
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Count valid parentheses substrings — order-of-arrival/departure matters.
