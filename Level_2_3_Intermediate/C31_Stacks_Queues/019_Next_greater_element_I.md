# Chapter: Next greater element I
...
## 1. Problem Statement
Master the topic: **Next greater element I**.
...
Monotonic decreasing stack scanning from right.
...
Think of **Next greater element I** as a stack of plates (LIFO) or a coffee-shop queue (FIFO).
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Next greater element I
int main() {
...
- **Core idea:** Next greater element I — order-of-arrival/departure matters.
