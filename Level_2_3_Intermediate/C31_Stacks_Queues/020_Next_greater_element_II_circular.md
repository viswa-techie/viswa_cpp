# Chapter: Next greater element II circular
...
## 1. Problem Statement
Master the topic: **Next greater element II circular**.
...
This problem exercises **Next greater element II circular** — a core concept in Stacks & Queues.
...
Think of **Next greater element II circular** as a stack of plates (LIFO) or a coffee-shop queue (FIFO).
...
#include <vector>
#include <string>
// Brute-force template for: Next greater element II circular
int solve_next_greater_element_ii_circular(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_next_greater_element_ii_circular(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Next greater element II circular
int solve_next_greater_element_ii_circular(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Next greater element II circular
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Next greater element II circular — order-of-arrival/departure matters.
