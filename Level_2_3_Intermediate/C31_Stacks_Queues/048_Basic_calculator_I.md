...
## 1. Problem Statement
Master the topic: **Basic calculator I**.
...
This problem exercises **Basic calculator I** — a core concept in Stacks & Queues.
...
Think of **Basic calculator I** as a stack of plates (LIFO) or a coffee-shop queue (FIFO).
...
#include <vector>
#include <string>
// Brute-force template for: Basic calculator I
int solve_basic_calculator_i(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_basic_calculator_i(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Basic calculator I
int solve_basic_calculator_i(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Basic calculator I
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Basic calculator I — order-of-arrival/departure matters.
