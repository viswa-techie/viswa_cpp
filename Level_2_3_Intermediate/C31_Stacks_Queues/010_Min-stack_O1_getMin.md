...
## 1. Problem Statement
Master the topic: **Min-stack O(1) getMin**.
...
Auxiliary stack tracks running minimum.
...
Think of **Min-stack O(1) getMin** as a stack of plates (LIFO) or a coffee-shop queue (FIFO).
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Min-stack O(1) getMin
int main() {
...
- **Core idea:** Min-stack O(1) getMin — order-of-arrival/departure matters.
