# Chapter: Sliding window max deque
...
## 1. Problem Statement
Master the topic: **Sliding window max deque**.
...
Monotonic decreasing deque holds candidate indices for max in window.
...
Think of **Sliding window max deque** as a stack of plates (LIFO) or a coffee-shop queue (FIFO).
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Sliding window max deque
int main() {
...
- **Core idea:** Sliding window max deque — order-of-arrival/departure matters.
