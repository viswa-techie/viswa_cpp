...
## 1. Problem Statement
Master the topic: **Valid parentheses**.
...
Push opens onto stack; for each close, pop and verify match.
...
Think of **Valid parentheses** as a stack of plates (LIFO) or a coffee-shop queue (FIFO).
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Valid parentheses
int main() {
...
- **Core idea:** Valid parentheses — order-of-arrival/departure matters.
