# Chapter: Evaluate reverse Polish notation
...
## 1. Problem Statement
Master the topic: **Evaluate reverse Polish notation**.
...
This problem exercises **Evaluate reverse Polish notation** — a core concept in Stacks & Queues.
...
Think of **Evaluate reverse Polish notation** as a stack of plates (LIFO) or a coffee-shop queue (FIFO).
...
#include <vector>
#include <string>
// Brute-force template for: Evaluate reverse Polish notation
int solve_evaluate_reverse_polish_notation(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_evaluate_reverse_polish_notation(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Evaluate reverse Polish notation
int solve_evaluate_reverse_polish_notation(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Evaluate reverse Polish notation
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Evaluate reverse Polish notation — order-of-arrival/departure matters.
