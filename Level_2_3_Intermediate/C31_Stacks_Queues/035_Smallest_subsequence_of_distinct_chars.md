# Chapter: Smallest subsequence of distinct chars
...
## 1. Problem Statement
Master the topic: **Smallest subsequence of distinct chars**.
...
This problem exercises **Smallest subsequence of distinct chars** — a core concept in Stacks & Queues.
...
Think of **Smallest subsequence of distinct chars** as a stack of plates (LIFO) or a coffee-shop queue (FIFO).
...
#include <vector>
#include <string>
// Brute-force template for: Smallest subsequence of distinct chars
int solve_smallest_subsequence_of_distinct_chars(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_smallest_subsequence_of_distinct_chars(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Smallest subsequence of distinct chars
int solve_smallest_subsequence_of_distinct_chars(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Smallest subsequence of distinct chars
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Smallest subsequence of distinct chars — order-of-arrival/departure matters.
