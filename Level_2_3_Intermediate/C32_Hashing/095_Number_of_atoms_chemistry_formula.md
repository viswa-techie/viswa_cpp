# Chapter: Number of atoms chemistry formula
...
## 1. Problem Statement
Master the topic: **Number of atoms chemistry formula**.
...
This problem exercises **Number of atoms chemistry formula** — a core concept in Hashing & Hash Tables.
...
Think of **Number of atoms chemistry formula** as a coat-check counter — give a key, get back the item in O(1).
...
#include <vector>
#include <string>
// Brute-force template for: Number of atoms chemistry formula
int solve_number_of_atoms_chemistry_formula(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_number_of_atoms_chemistry_formula(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Number of atoms chemistry formula
int solve_number_of_atoms_chemistry_formula(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Number of atoms chemistry formula
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Number of atoms chemistry formula — O(1) average lookup via hash function.
