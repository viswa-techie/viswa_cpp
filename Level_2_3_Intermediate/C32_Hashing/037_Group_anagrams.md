...
## 1. Problem Statement
Master the topic: **Group anagrams**.
...
Think of **Group anagrams** as a coat-check counter — give a key, get back the item in O(1).
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Group anagrams
int main() {
...
- **Core idea:** Group anagrams — O(1) average lookup via hash function.
