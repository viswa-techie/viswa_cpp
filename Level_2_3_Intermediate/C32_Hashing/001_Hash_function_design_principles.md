# Chapter: Hash function design principles
...
## 1. Problem Statement
Master the topic: **Hash function design principles**.
...
This problem exercises **Hash function design principles** — a core concept in Hashing & Hash Tables.
...
Think of **Hash function design principles** as a coat-check counter — give a key, get back the item in O(1).
...
#include <vector>
#include <string>
// Brute-force template for: Hash function design principles
int solve_hash_function_design_principles(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_hash_function_design_principles(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Hash function design principles
int solve_hash_function_design_principles(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Hash function design principles
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Hash function design principles — O(1) average lookup via hash function.
