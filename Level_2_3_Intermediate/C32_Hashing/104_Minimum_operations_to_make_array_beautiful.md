# Chapter: Minimum operations to make array beautiful
...
## 1. Problem Statement
Master the topic: **Minimum operations to make array beautiful**.
...
This problem exercises **Minimum operations to make array beautiful** — a core concept in Hashing & Hash Tables.
...
Think of **Minimum operations to make array beautiful** as a coat-check counter — give a key, get back the item in O(1).
...
#include <vector>
#include <string>
// Brute-force template for: Minimum operations to make array beautiful
int solve_minimum_operations_to_make_array_beautif(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_minimum_operations_to_make_array_beautif(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Minimum operations to make array beautiful
int solve_minimum_operations_to_make_array_beautif(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Minimum operations to make array beautiful
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Minimum operations to make array beautiful — O(1) average lookup via hash function.
