# Chapter: Cache-efficient hash table Robin Hood
...
## 1. Problem Statement
Master the topic: **Cache-efficient hash table Robin Hood**.
...
This problem exercises **Cache-efficient hash table Robin Hood** — a core concept in Hashing & Hash Tables.
...
Think of **Cache-efficient hash table Robin Hood** as a coat-check counter — give a key, get back the item in O(1).
...
#include <vector>
#include <string>
// Brute-force template for: Cache-efficient hash table Robin Hood
int solve_cache_efficient_hash_table_robin_hood(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_cache_efficient_hash_table_robin_hood(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Cache-efficient hash table Robin Hood
int solve_cache_efficient_hash_table_robin_hood(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Cache-efficient hash table Robin Hood
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Cache-efficient hash table Robin Hood — O(1) average lookup via hash function.
