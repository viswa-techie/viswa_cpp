...
## 1. Problem Statement
Master the topic: **Valid anagram**.
...
Count chars; compare counts (or sort both strings).
...
Think of **Valid anagram** as a coat-check counter — give a key, get back the item in O(1).
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Valid anagram
int main() {
...
- **Core idea:** Valid anagram — O(1) average lookup via hash function.
