# Chapter: Longest substring with at most K distinct
...
## 1. Problem Statement
Master the topic: **Longest substring with at most K distinct**.
...
Think of **Longest substring with at most K distinct** as a coat-check counter — give a key, get back the item in O(1).
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Longest substring with at most K distinct
int main() {
...
- **Core idea:** Longest substring with at most K distinct — O(1) average lookup via hash function.
