# Chapter: Substring with concatenation of all words
...
## 1. Problem Statement
Master the topic: **Substring with concatenation of all words**.
...
This problem exercises **Substring with concatenation of all words** — a core concept in Hashing & Hash Tables.
...
Think of **Substring with concatenation of all words** as a coat-check counter — give a key, get back the item in O(1).
...
#include <vector>
#include <string>
// Brute-force template for: Substring with concatenation of all words
int solve_substring_with_concatenation_of_all_word(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_substring_with_concatenation_of_all_word(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Substring with concatenation of all words
int solve_substring_with_concatenation_of_all_word(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Substring with concatenation of all words
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Substring with concatenation of all words — O(1) average lookup via hash function.
