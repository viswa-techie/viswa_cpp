# Chapter: Intersection of two arrays II
...
## 1. Problem Statement
Master the topic: **Intersection of two arrays II**.
...
This problem exercises **Intersection of two arrays II** — a core concept in Hashing & Hash Tables.
...
Think of **Intersection of two arrays II** as a coat-check counter — give a key, get back the item in O(1).
...
#include <vector>
#include <string>
// Brute-force template for: Intersection of two arrays II
int solve_intersection_of_two_arrays_ii(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_intersection_of_two_arrays_ii(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Intersection of two arrays II
int solve_intersection_of_two_arrays_ii(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Intersection of two arrays II
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Intersection of two arrays II — O(1) average lookup via hash function.
