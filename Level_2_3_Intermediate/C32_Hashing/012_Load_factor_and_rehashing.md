...
This problem exercises **Load factor and rehashing** — a core concept in Hashing & Hash Tables.
...
Think of **Load factor and rehashing** as a coat-check counter — give a key, get back the item in O(1).
...
- **Core idea:** Load factor and rehashing — O(1) average lookup via hash function.
