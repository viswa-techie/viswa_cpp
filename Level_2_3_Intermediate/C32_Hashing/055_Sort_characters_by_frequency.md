...
This problem exercises **Sort characters by frequency** — a core concept in Hashing & Hash Tables.
...
Think of **Sort characters by frequency** as a coat-check counter — give a key, get back the item in O(1).
...
- **Core idea:** Sort characters by frequency — O(1) average lookup via hash function.
