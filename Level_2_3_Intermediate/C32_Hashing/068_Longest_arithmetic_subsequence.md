# Chapter: Longest arithmetic subsequence
...
## 1. Problem Statement
Master the topic: **Longest arithmetic subsequence**.
...
This problem exercises **Longest arithmetic subsequence** — a core concept in Hashing & Hash Tables.
...
Think of **Longest arithmetic subsequence** as a coat-check counter — give a key, get back the item in O(1).
...
#include <vector>
#include <string>
// Brute-force template for: Longest arithmetic subsequence
int solve_longest_arithmetic_subsequence(std::vector<int> v) {
    int result = 0;
...
int main() {
    ...
    std::cout << solve_longest_arithmetic_subsequence(v) << "\n";
}
```
**Time:** O(n²)  
**Space:** O(1)  
...
#include <vector>
#include <algorithm>
// Optimized one-pass template for: Longest arithmetic subsequence
int solve_longest_arithmetic_subsequence(const std::vector<int>& v) {
    if (v.empty()) return 0;
...
#include <numeric>
#include <algorithm>
// STL idiomatic template for: Longest arithmetic subsequence
int main() {
    std::vector<int> v = {1,2,3,4,5};
...
- **Core idea:** Longest arithmetic subsequence — O(1) average lookup via hash function.
