# Chapter: std bit_floor bit_ceil popcount C++20
...
**Topic:** std bit_floor bit_ceil popcount C++20
...
**Correctness proof sketch for std bit_floor bit_ceil popcount C++20:**
...
```
ALGORITHM STD_BIT_FLOOR_BIT_CEIL_POPCOUNT_C++20(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: std bit_floor bit_ceil popcount C++20
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: std bit_floor bit_ceil popcount C++20" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: std bit_floor bit_ceil popcount C++20
