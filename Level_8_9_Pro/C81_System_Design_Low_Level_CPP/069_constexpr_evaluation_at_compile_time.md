# Chapter: constexpr evaluation at compile time
...
**Topic:** constexpr evaluation at compile time
...
**Correctness proof sketch for constexpr evaluation at compile time:**
...
```
ALGORITHM CONSTEXPR_EVALUATION_AT_COMPILE_TIME(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: constexpr evaluation at compile time
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: constexpr evaluation at compile time" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: constexpr evaluation at compile time
