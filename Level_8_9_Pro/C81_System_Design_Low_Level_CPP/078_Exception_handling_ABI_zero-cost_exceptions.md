# Chapter: Exception handling ABI zero-cost exceptions
...
**Topic:** Exception handling ABI zero-cost exceptions
...
**Correctness proof sketch for Exception handling ABI zero-cost exceptions:**
...
```
ALGORITHM EXCEPTION_HANDLING_ABI_ZERO-COST_EXCEPTIONS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Exception handling ABI zero-cost exceptions
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Exception handling ABI zero-cost exceptions" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Exception handling ABI zero-cost exceptions
