# Chapter: Non-blocking IO with epoll
...
**Topic:** Non-blocking IO with epoll
...
**Correctness proof sketch for Non-blocking IO with epoll:**
...
```
ALGORITHM NON-BLOCKING_IO_WITH_EPOLL(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Non-blocking IO with epoll
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Non-blocking IO with epoll" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Non-blocking IO with epoll
