...
**Correctness proof sketch for C interop extern C:**
...
```
ALGORITHM C_INTEROP_EXTERN_C(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: C interop extern C
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: C interop extern C" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: C interop extern C
