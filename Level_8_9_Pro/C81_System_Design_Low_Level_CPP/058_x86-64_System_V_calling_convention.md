# Chapter: x86-64 System V calling convention
...
**Topic:** x86-64 System V calling convention
...
**Correctness proof sketch for x86-64 System V calling convention:**
...
```
ALGORITHM X86-64_SYSTEM_V_CALLING_CONVENTION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: x86-64 System V calling convention
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: x86-64 System V calling convention" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: x86-64 System V calling convention
