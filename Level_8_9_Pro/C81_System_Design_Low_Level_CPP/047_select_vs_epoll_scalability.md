# Chapter: select vs epoll scalability
...
**Topic:** select vs epoll scalability
...
**Correctness proof sketch for select vs epoll scalability:**
...
```
ALGORITHM SELECT_VS_EPOLL_SCALABILITY(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: select vs epoll scalability
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: select vs epoll scalability" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: select vs epoll scalability
