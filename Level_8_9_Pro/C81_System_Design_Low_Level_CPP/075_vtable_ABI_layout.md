...
**Correctness proof sketch for vtable ABI layout:**
...
```
ALGORITHM VTABLE_ABI_LAYOUT(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: vtable ABI layout
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: vtable ABI layout" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: vtable ABI layout
