...
**Topic:** Link-time optimization LTO
...
**Correctness proof sketch for Link-time optimization LTO:**
...
```
ALGORITHM LINK-TIME_OPTIMIZATION_LTO(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Link-time optimization LTO
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Link-time optimization LTO" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Link-time optimization LTO
