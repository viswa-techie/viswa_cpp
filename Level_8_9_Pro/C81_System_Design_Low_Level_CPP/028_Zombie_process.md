...
**Correctness proof sketch for Zombie process:**
...
```
ALGORITHM ZOMBIE_PROCESS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Zombie process
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Zombie process" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Zombie process
