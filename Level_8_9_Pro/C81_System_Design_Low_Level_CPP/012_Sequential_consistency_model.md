# Chapter: Sequential consistency model
...
**Topic:** Sequential consistency model
...
**Correctness proof sketch for Sequential consistency model:**
...
```
ALGORITHM SEQUENTIAL_CONSISTENCY_MODEL(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Sequential consistency model
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Sequential consistency model" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Sequential consistency model
