...
**Correctness proof sketch for dynamic_cast ABI:**
...
```
ALGORITHM DYNAMIC_CAST_ABI(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: dynamic_cast ABI
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: dynamic_cast ABI" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: dynamic_cast ABI
