...
**Correctness proof sketch for DMA concept:**
...
#include <iostream>
#include <vector>
// Production implementation template for: DMA concept
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: DMA concept" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: DMA concept
