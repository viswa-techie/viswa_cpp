# Chapter: Blocking vs non-blocking socket
...
**Topic:** Blocking vs non-blocking socket
...
**Correctness proof sketch for Blocking vs non-blocking socket:**
...
```
ALGORITHM BLOCKING_VS_NON-BLOCKING_SOCKET(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Blocking vs non-blocking socket
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Blocking vs non-blocking socket" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Blocking vs non-blocking socket
