...
**Correctness proof sketch for Constant folding:**
...
```
ALGORITHM CONSTANT_FOLDING(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Constant folding
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Constant folding" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Constant folding
