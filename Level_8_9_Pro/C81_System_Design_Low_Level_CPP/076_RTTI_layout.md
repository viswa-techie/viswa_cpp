...
**Correctness proof sketch for RTTI layout:**
...
#include <iostream>
#include <vector>
// Production implementation template for: RTTI layout
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: RTTI layout" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: RTTI layout
