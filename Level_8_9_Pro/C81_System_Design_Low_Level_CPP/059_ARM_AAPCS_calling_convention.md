# Chapter: ARM AAPCS calling convention
...
**Topic:** ARM AAPCS calling convention
...
**Correctness proof sketch for ARM AAPCS calling convention:**
...
```
ALGORITHM ARM_AAPCS_CALLING_CONVENTION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: ARM AAPCS calling convention
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: ARM AAPCS calling convention" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: ARM AAPCS calling convention
