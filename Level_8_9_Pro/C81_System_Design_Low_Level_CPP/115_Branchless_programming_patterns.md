# Chapter: Branchless programming patterns
...
**Topic:** Branchless programming patterns
...
**Correctness proof sketch for Branchless programming patterns:**
...
```
ALGORITHM BRANCHLESS_PROGRAMMING_PATTERNS(input):
