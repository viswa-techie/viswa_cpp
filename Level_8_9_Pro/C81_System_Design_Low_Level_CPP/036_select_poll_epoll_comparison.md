# Chapter: select poll epoll comparison
...
**Topic:** select poll epoll comparison
...
**Correctness proof sketch for select poll epoll comparison:**
...
```
ALGORITHM SELECT_POLL_EPOLL_COMPARISON(input):
