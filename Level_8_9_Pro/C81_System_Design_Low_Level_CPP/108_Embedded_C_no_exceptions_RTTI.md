# Chapter: Embedded C++ no exceptions RTTI
...
**Topic:** Embedded C++ no exceptions RTTI
...
**Correctness proof sketch for Embedded C++ no exceptions RTTI:**
...
```
ALGORITHM EMBEDDED_C++_NO_EXCEPTIONS_RTTI(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Embedded C++ no exceptions RTTI
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Embedded C++ no exceptions RTTI" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Embedded C++ no exceptions RTTI
