# Chapter: Node.js native addon N-API
...
**Topic:** Node.js native addon N-API
...
**Correctness proof sketch for Node.js native addon N-API:**
...
```
ALGORITHM NODE.JS_NATIVE_ADDON_N-API(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Node.js native addon N-API
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Node.js native addon N-API" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Node.js native addon N-API
