# Chapter: CDQ divide and conquer offline 3D
...
**Topic:** CDQ divide and conquer offline 3D
...
**Correctness proof sketch for CDQ divide and conquer offline 3D:**
...
```
ALGORITHM CDQ_DIVIDE_AND_CONQUER_OFFLINE_3D(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: CDQ divide and conquer offline 3D
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: CDQ divide and conquer offline 3D" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: CDQ divide and conquer offline 3D
