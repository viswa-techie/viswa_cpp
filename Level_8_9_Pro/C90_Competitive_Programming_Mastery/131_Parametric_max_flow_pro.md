# Chapter: Parametric max flow pro
...
**Correctness proof sketch for Parametric max flow pro:**
...
```
ALGORITHM PARAMETRIC_MAX_FLOW_PRO(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Parametric max flow pro
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Parametric max flow pro" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Parametric max flow pro
