# Chapter: Convex hull trick rotating calipers
...
**Topic:** Convex hull trick rotating calipers
...
**Correctness proof sketch for Convex hull trick rotating calipers:**
...
```
ALGORITHM CONVEX_HULL_TRICK_ROTATING_CALIPERS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Convex hull trick rotating calipers
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Convex hull trick rotating calipers" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Convex hull trick rotating calipers
