# Chapter: Randomized quick select
...
**Correctness proof sketch for Randomized quick select:**
...
```
ALGORITHM RANDOMIZED_QUICK_SELECT(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Randomized quick select
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Randomized quick select" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Randomized quick select
