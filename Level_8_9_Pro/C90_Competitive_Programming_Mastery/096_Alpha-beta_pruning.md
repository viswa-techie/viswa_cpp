...
**Correctness proof sketch for Alpha-beta pruning:**
...
```
ALGORITHM ALPHA-BETA_PRUNING(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Alpha-beta pruning
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Alpha-beta pruning" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Alpha-beta pruning
