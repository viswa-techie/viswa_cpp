# Chapter: Gaussian elimination over GF2
...
**Topic:** Gaussian elimination over GF2
...
**Correctness proof sketch for Gaussian elimination over GF2:**
...
```
ALGORITHM GAUSSIAN_ELIMINATION_OVER_GF2(input):
