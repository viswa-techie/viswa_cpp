# Chapter: Suffix array plus LCP for string queries
...
**Topic:** Suffix array plus LCP for string queries
...
**Correctness proof sketch for Suffix array plus LCP for string queries:**
...
```
ALGORITHM SUFFIX_ARRAY_PLUS_LCP_FOR_STRING_QUERIES(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Suffix array plus LCP for string queries
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Suffix array plus LCP for string queries" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Suffix array plus LCP for string queries
