# Chapter: Miller-Rabin error probability
...
**Topic:** Miller-Rabin error probability
...
**Correctness proof sketch for Miller-Rabin error probability:**
...
```
ALGORITHM MILLER-RABIN_ERROR_PROBABILITY(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Miller-Rabin error probability
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Miller-Rabin error probability" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Miller-Rabin error probability
