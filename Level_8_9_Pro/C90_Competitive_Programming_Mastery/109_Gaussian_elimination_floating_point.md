# Chapter: Gaussian elimination floating point
...
**Topic:** Gaussian elimination floating point
...
**Correctness proof sketch for Gaussian elimination floating point:**
...
```
ALGORITHM GAUSSIAN_ELIMINATION_FLOATING_POINT(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Gaussian elimination floating point
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Gaussian elimination floating point" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Gaussian elimination floating point
