# Chapter: Half-plane intersection
...
**Correctness proof sketch for Half-plane intersection:**
...
```
ALGORITHM HALF-PLANE_INTERSECTION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Half-plane intersection
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Half-plane intersection" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Half-plane intersection
