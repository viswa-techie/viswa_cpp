...
**Correctness proof sketch for Green hackenbush:**
...
```
ALGORITHM GREEN_HACKENBUSH(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Green hackenbush
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Green hackenbush" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Green hackenbush
