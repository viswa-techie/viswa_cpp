# Chapter: Closest pair of points divide conquer
...
**Correctness proof sketch for Closest pair of points divide conquer:**
...
```
ALGORITHM CLOSEST_PAIR_OF_POINTS_DIVIDE_CONQUER(input):
