# Chapter: Li Chao tree line container
...
**Topic:** Li Chao tree line container
...
**Correctness proof sketch for Li Chao tree line container:**
...
```
ALGORITHM LI_CHAO_TREE_LINE_CONTAINER(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Li Chao tree line container
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Li Chao tree line container" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Li Chao tree line container
