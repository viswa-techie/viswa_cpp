# Chapter: Suffix automaton extended problems
...
**Topic:** Suffix automaton extended problems
...
**Correctness proof sketch for Suffix automaton extended problems:**
...
```
ALGORITHM SUFFIX_AUTOMATON_EXTENDED_PROBLEMS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Suffix automaton extended problems
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Suffix automaton extended problems" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Suffix automaton extended problems
