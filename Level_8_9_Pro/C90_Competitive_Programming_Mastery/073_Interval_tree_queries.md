...
**Correctness proof sketch for Interval tree queries:**
...
```
ALGORITHM INTERVAL_TREE_QUERIES(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Interval tree queries
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Interval tree queries" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Interval tree queries
