# Chapter: Persistent segment tree pro
...
**Topic:** Persistent segment tree pro
...
**Correctness proof sketch for Persistent segment tree pro:**
...
```
ALGORITHM PERSISTENT_SEGMENT_TREE_PRO(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Persistent segment tree pro
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Persistent segment tree pro" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Persistent segment tree pro
