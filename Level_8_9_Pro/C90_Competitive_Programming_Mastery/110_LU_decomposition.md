...
**Correctness proof sketch for LU decomposition:**
...
```
ALGORITHM LU_DECOMPOSITION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: LU decomposition
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: LU decomposition" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: LU decomposition
