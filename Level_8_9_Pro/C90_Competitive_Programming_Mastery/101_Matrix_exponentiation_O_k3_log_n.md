# Chapter: Matrix exponentiation O k3 log n
...
**Topic:** Matrix exponentiation O k3 log n
...
**Correctness proof sketch for Matrix exponentiation O k3 log n:**
...
```
ALGORITHM MATRIX_EXPONENTIATION_O_K3_LOG_N(input):
