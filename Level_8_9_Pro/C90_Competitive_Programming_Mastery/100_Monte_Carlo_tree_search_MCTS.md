# Chapter: Monte Carlo tree search MCTS
...
**Correctness proof sketch for Monte Carlo tree search MCTS:**
...
```
ALGORITHM MONTE_CARLO_TREE_SEARCH_MCTS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Monte Carlo tree search MCTS
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Monte Carlo tree search MCTS" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Monte Carlo tree search MCTS
