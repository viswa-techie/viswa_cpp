...
**Correctness proof sketch for Nim game variants:**
...
```
ALGORITHM NIM_GAME_VARIANTS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Nim game variants
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Nim game variants" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Nim game variants
