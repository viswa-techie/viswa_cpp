# Chapter: Link-cut tree full dynamic trees
...
**Topic:** Link-cut tree full dynamic trees
...
**Correctness proof sketch for Link-cut tree full dynamic trees:**
...
```
ALGORITHM LINK-CUT_TREE_FULL_DYNAMIC_TREES(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Link-cut tree full dynamic trees
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Link-cut tree full dynamic trees" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Link-cut tree full dynamic trees
