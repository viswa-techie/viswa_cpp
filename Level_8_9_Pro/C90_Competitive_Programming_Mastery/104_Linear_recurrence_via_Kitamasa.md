# Chapter: Linear recurrence via Kitamasa
...
**Topic:** Linear recurrence via Kitamasa
...
**Correctness proof sketch for Linear recurrence via Kitamasa:**
...
```
ALGORITHM LINEAR_RECURRENCE_VIA_KITAMASA(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Linear recurrence via Kitamasa
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Linear recurrence via Kitamasa" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Linear recurrence via Kitamasa
