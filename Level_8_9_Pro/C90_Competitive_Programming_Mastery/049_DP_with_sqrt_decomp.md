...
**Correctness proof sketch for DP with sqrt decomp:**
...
```
ALGORITHM DP_WITH_SQRT_DECOMP(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: DP with sqrt decomp
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: DP with sqrt decomp" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: DP with sqrt decomp
