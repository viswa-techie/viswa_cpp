# Chapter: Linearity of expectation tricks
...
**Topic:** Linearity of expectation tricks
...
**Correctness proof sketch for Linearity of expectation tricks:**
...
```
ALGORITHM LINEARITY_OF_EXPECTATION_TRICKS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Linearity of expectation tricks
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Linearity of expectation tricks" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Linearity of expectation tricks
