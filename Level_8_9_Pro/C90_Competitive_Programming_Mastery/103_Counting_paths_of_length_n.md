# Chapter: Counting paths of length n
...
**Topic:** Counting paths of length n
...
**Correctness proof sketch for Counting paths of length n:**
...
```
ALGORITHM COUNTING_PATHS_OF_LENGTH_N(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Counting paths of length n
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Counting paths of length n" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Counting paths of length n
