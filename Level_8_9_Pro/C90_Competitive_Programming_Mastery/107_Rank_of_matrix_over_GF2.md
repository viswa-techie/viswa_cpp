# Chapter: Rank of matrix over GF2
...
**Correctness proof sketch for Rank of matrix over GF2:**
...
```
ALGORITHM RANK_OF_MATRIX_OVER_GF2(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Rank of matrix over GF2
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Rank of matrix over GF2" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Rank of matrix over GF2
