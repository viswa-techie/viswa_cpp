# Chapter: Rotating calipers technique
...
**Topic:** Rotating calipers technique
...
**Correctness proof sketch for Rotating calipers technique:**
...
```
ALGORITHM ROTATING_CALIPERS_TECHNIQUE(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Rotating calipers technique
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Rotating calipers technique" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Rotating calipers technique
