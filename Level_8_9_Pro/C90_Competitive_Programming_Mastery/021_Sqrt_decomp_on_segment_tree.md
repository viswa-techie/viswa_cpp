# Chapter: Sqrt decomp on segment tree
...
**Topic:** Sqrt decomp on segment tree
...
**Correctness proof sketch for Sqrt decomp on segment tree:**
...
```
ALGORITHM SQRT_DECOMP_ON_SEGMENT_TREE(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Sqrt decomp on segment tree
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Sqrt decomp on segment tree" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Sqrt decomp on segment tree
