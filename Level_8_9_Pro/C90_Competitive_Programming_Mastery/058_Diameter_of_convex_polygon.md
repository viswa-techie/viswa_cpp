# Chapter: Diameter of convex polygon
...
**Topic:** Diameter of convex polygon
...
**Correctness proof sketch for Diameter of convex polygon:**
...
```
ALGORITHM DIAMETER_OF_CONVEX_POLYGON(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Diameter of convex polygon
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Diameter of convex polygon" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Diameter of convex polygon
