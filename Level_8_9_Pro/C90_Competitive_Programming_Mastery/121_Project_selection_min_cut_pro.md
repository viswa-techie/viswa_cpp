# Chapter: Project selection min cut pro
...
**Topic:** Project selection min cut pro
...
**Correctness proof sketch for Project selection min cut pro:**
...
```
ALGORITHM PROJECT_SELECTION_MIN_CUT_PRO(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Project selection min cut pro
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Project selection min cut pro" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Project selection min cut pro
