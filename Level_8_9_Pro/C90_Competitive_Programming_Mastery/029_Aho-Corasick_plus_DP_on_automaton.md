# Chapter: Aho-Corasick plus DP on automaton
...
**Topic:** Aho-Corasick plus DP on automaton
...
**Correctness proof sketch for Aho-Corasick plus DP on automaton:**
...
```
ALGORITHM AHO-CORASICK_PLUS_DP_ON_AUTOMATON(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Aho-Corasick plus DP on automaton
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Aho-Corasick plus DP on automaton" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Aho-Corasick plus DP on automaton
