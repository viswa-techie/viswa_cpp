# Chapter: Hirschberg space-optimized LCS
...
**Topic:** Hirschberg space-optimized LCS
...
**Correctness proof sketch for Hirschberg space-optimized LCS:**
...
```
ALGORITHM HIRSCHBERG_SPACE-OPTIMIZED_LCS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Hirschberg space-optimized LCS
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Hirschberg space-optimized LCS" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Hirschberg space-optimized LCS
