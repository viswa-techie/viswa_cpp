...
**Correctness proof sketch for Mo algorithm on trees:**
...
```
ALGORITHM MO_ALGORITHM_ON_TREES(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Mo algorithm on trees
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Mo algorithm on trees" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Mo algorithm on trees
