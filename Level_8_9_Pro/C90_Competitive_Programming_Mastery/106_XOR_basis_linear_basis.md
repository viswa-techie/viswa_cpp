# Chapter: XOR basis linear basis
...
**Correctness proof sketch for XOR basis linear basis:**
...
```
ALGORITHM XOR_BASIS_LINEAR_BASIS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: XOR basis linear basis
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: XOR basis linear basis" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: XOR basis linear basis
