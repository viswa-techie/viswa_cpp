# Chapter: Segment intersection Bentley-Ottmann
...
**Topic:** Segment intersection Bentley-Ottmann
...
**Correctness proof sketch for Segment intersection Bentley-Ottmann:**
...
```
ALGORITHM SEGMENT_INTERSECTION_BENTLEY-OTTMANN(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Segment intersection Bentley-Ottmann
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Segment intersection Bentley-Ottmann" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Segment intersection Bentley-Ottmann
