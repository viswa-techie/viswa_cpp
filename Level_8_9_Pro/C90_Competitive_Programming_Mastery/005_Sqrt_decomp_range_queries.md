# Chapter: Sqrt decomp range queries
...
**Topic:** Sqrt decomp range queries
...
**Correctness proof sketch for Sqrt decomp range queries:**
...
```
ALGORITHM SQRT_DECOMP_RANGE_QUERIES(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Sqrt decomp range queries
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Sqrt decomp range queries" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Sqrt decomp range queries
