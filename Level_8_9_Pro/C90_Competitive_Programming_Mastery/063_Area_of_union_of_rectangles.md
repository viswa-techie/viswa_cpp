# Chapter: Area of union of rectangles
...
**Topic:** Area of union of rectangles
...
**Correctness proof sketch for Area of union of rectangles:**
...
```
ALGORITHM AREA_OF_UNION_OF_RECTANGLES(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Area of union of rectangles
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Area of union of rectangles" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Area of union of rectangles
