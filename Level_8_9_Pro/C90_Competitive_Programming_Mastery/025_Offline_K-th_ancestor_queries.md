# Chapter: Offline K-th ancestor queries
...
**Topic:** Offline K-th ancestor queries
...
**Correctness proof sketch for Offline K-th ancestor queries:**
...
```
ALGORITHM OFFLINE_K-TH_ANCESTOR_QUERIES(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Offline K-th ancestor queries
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Offline K-th ancestor queries" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Offline K-th ancestor queries
