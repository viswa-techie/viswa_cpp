...
**Correctness proof sketch for Markov chains in CP:**
...
```
ALGORITHM MARKOV_CHAINS_IN_CP(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Markov chains in CP
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Markov chains in CP" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Markov chains in CP
