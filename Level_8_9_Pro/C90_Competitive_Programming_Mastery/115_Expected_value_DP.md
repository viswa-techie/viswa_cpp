...
**Correctness proof sketch for Expected value DP:**
...
```
ALGORITHM EXPECTED_VALUE_DP(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Expected value DP
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Expected value DP" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Expected value DP
