# Chapter: MCMF minimum cost matching
...
**Topic:** MCMF minimum cost matching
...
**Correctness proof sketch for MCMF minimum cost matching:**
...
```
ALGORITHM MCMF_MINIMUM_COST_MATCHING(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: MCMF minimum cost matching
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: MCMF minimum cost matching" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: MCMF minimum cost matching
