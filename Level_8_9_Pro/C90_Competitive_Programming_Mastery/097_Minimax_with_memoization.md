# Chapter: Minimax with memoization
...
**Topic:** Minimax with memoization
...
**Correctness proof sketch for Minimax with memoization:**
...
```
ALGORITHM MINIMAX_WITH_MEMOIZATION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Minimax with memoization
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Minimax with memoization" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Minimax with memoization
