# Chapter: Convex hull Andrew monotone chain
...
**Topic:** Convex hull Andrew monotone chain
...
**Correctness proof sketch for Convex hull Andrew monotone chain:**
...
```
ALGORITHM CONVEX_HULL_ANDREW_MONOTONE_CHAIN(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Convex hull Andrew monotone chain
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Convex hull Andrew monotone chain" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Convex hull Andrew monotone chain
