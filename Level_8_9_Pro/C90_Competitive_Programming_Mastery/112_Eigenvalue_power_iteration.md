# Chapter: Eigenvalue power iteration
...
**Topic:** Eigenvalue power iteration
...
**Correctness proof sketch for Eigenvalue power iteration:**
...
```
ALGORITHM EIGENVALUE_POWER_ITERATION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Eigenvalue power iteration
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Eigenvalue power iteration" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Eigenvalue power iteration
