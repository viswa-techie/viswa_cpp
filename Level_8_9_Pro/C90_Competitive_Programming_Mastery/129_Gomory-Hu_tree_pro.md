...
**Correctness proof sketch for Gomory-Hu tree pro:**
...
```
ALGORITHM GOMORY-HU_TREE_PRO(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Gomory-Hu tree pro
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Gomory-Hu tree pro" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Gomory-Hu tree pro
