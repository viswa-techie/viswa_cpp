...
**Correctness proof sketch for Four Russians method:**
...
```
ALGORITHM FOUR_RUSSIANS_METHOD(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Four Russians method
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Four Russians method" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Four Russians method
