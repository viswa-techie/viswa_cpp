...
**Correctness proof sketch for SOS DP O n 2n:**
...
#include <iostream>
#include <vector>
// Production implementation template for: SOS DP O n 2n
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: SOS DP O n 2n" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: SOS DP O n 2n
