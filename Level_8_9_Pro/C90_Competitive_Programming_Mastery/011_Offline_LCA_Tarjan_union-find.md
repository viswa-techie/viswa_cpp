# Chapter: Offline LCA Tarjan union-find
...
**Topic:** Offline LCA Tarjan union-find
...
**Correctness proof sketch for Offline LCA Tarjan union-find:**
...
```
ALGORITHM OFFLINE_LCA_TARJAN_UNION-FIND(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Offline LCA Tarjan union-find
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Offline LCA Tarjan union-find" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Offline LCA Tarjan union-find
