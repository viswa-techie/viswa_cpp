# Chapter: Point location in triangulation
...
**Topic:** Point location in triangulation
...
**Correctness proof sketch for Point location in triangulation:**
...
```
ALGORITHM POINT_LOCATION_IN_TRIANGULATION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Point location in triangulation
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Point location in triangulation" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Point location in triangulation
