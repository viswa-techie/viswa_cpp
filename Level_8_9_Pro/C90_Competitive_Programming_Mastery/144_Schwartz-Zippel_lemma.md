...
**Correctness proof sketch for Schwartz-Zippel lemma:**
...
```
ALGORITHM SCHWARTZ-ZIPPEL_LEMMA(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Schwartz-Zippel lemma
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Schwartz-Zippel lemma" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Schwartz-Zippel lemma
