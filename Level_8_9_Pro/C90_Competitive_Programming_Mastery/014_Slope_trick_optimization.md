# Chapter: Slope trick optimization
...
**Topic:** Slope trick optimization
...
**Correctness proof sketch for Slope trick optimization:**
...
```
ALGORITHM SLOPE_TRICK_OPTIMIZATION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Slope trick optimization
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Slope trick optimization" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Slope trick optimization
