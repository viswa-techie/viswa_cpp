...
**Correctness proof sketch for DSU on tree Sack:**
...
```
ALGORITHM DSU_ON_TREE_SACK(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: DSU on tree Sack
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: DSU on tree Sack" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: DSU on tree Sack
