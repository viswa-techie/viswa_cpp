...
**Correctness proof sketch for Jarvis march:**
...
#include <iostream>
#include <vector>
// Production implementation template for: Jarvis march
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Jarvis march" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Jarvis march
