...
**Correctness proof sketch for Orthogonal range searching:**
...
```
ALGORITHM ORTHOGONAL_RANGE_SEARCHING(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Orthogonal range searching
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Orthogonal range searching" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Orthogonal range searching
