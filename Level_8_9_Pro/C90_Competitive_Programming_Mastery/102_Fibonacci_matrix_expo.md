...
**Correctness proof sketch for Fibonacci matrix expo:**
...
```
ALGORITHM FIBONACCI_MATRIX_EXPO(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Fibonacci matrix expo
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Fibonacci matrix expo" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Fibonacci matrix expo
