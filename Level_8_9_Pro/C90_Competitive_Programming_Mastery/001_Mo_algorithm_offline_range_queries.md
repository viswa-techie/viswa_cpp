# Chapter: Mo algorithm offline range queries
...
**Topic:** Mo algorithm offline range queries
...
**Correctness proof sketch for Mo algorithm offline range queries:**
...
```
ALGORITHM MO_ALGORITHM_OFFLINE_RANGE_QUERIES(input):
