...
**Correctness proof sketch for Offline LCT queries:**
...
```
ALGORITHM OFFLINE_LCT_QUERIES(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Offline LCT queries
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Offline LCT queries" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Offline LCT queries
