# Chapter: DP with convex hull trick
...
**Topic:** DP with convex hull trick
...
**Correctness proof sketch for DP with convex hull trick:**
...
```
ALGORITHM DP_WITH_CONVEX_HULL_TRICK(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: DP with convex hull trick
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: DP with convex hull trick" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: DP with convex hull trick
