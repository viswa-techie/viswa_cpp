# Chapter: Gomory-Hu cut tree pro
...
**Correctness proof sketch for Gomory-Hu cut tree pro:**
...
```
ALGORITHM GOMORY-HU_CUT_TREE_PRO(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Gomory-Hu cut tree pro
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Gomory-Hu cut tree pro" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Gomory-Hu cut tree pro
