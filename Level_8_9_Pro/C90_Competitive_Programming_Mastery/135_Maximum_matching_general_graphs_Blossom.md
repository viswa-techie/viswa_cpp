# Chapter: Maximum matching general graphs Blossom
...
**Topic:** Maximum matching general graphs Blossom
...
**Correctness proof sketch for Maximum matching general graphs Blossom:**
...
```
ALGORITHM MAXIMUM_MATCHING_GENERAL_GRAPHS_BLOSSOM(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Maximum matching general graphs Blossom
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Maximum matching general graphs Blossom" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Maximum matching general graphs Blossom
