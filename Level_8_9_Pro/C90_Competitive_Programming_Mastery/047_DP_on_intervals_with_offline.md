# Chapter: DP on intervals with offline
...
**Topic:** DP on intervals with offline
...
**Correctness proof sketch for DP on intervals with offline:**
...
```
ALGORITHM DP_ON_INTERVALS_WITH_OFFLINE(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: DP on intervals with offline
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: DP on intervals with offline" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: DP on intervals with offline
