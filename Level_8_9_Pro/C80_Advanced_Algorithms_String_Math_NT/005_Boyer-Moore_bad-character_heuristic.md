# Chapter: Boyer-Moore bad-character heuristic
...
**Topic:** Boyer-Moore bad-character heuristic
...
**Correctness proof sketch for Boyer-Moore bad-character heuristic:**
...
```
ALGORITHM BOYER-MOORE_BAD-CHARACTER_HEURISTIC(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Boyer-Moore bad-character heuristic
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Boyer-Moore bad-character heuristic" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Boyer-Moore bad-character heuristic
