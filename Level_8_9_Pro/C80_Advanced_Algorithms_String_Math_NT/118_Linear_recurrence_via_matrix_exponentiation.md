# Chapter: Linear recurrence via matrix exponentiation
...
**Topic:** Linear recurrence via matrix exponentiation
...
**Correctness proof sketch for Linear recurrence via matrix exponentiation:**
...
```
ALGORITHM LINEAR_RECURRENCE_VIA_MATRIX_EXPONENTIATION(input):
