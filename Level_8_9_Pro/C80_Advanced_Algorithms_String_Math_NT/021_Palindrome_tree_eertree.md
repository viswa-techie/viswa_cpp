...
**Correctness proof sketch for Palindrome tree eertree:**
...
```
ALGORITHM PALINDROME_TREE_EERTREE(input):
...
#include <iostream>
#include <vector>
// Competitive programming version for: Palindrome tree eertree
