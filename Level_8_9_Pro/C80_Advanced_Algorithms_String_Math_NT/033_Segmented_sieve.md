...
**Correctness proof sketch for Segmented sieve:**
...
```
ALGORITHM SEGMENTED_SIEVE(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Segmented sieve
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Segmented sieve" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Segmented sieve
