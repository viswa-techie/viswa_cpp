...
**Correctness proof sketch for Quadratic reciprocity:**
...
```
ALGORITHM QUADRATIC_RECIPROCITY(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Quadratic reciprocity
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Quadratic reciprocity" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Quadratic reciprocity
