...
**Correctness proof sketch for Suffix automaton SAM build:**
...
```
ALGORITHM SUFFIX_AUTOMATON_SAM_BUILD(input):
...
#include <iostream>
#include <vector>
// Competitive programming version for: Suffix automaton SAM build
