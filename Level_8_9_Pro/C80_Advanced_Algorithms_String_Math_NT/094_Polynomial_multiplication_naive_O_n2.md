# Chapter: Polynomial multiplication naive O n2
...
**Topic:** Polynomial multiplication naive O n2
...
**Correctness proof sketch for Polynomial multiplication naive O n2:**
...
```
ALGORITHM POLYNOMIAL_MULTIPLICATION_NAIVE_O_N2(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Polynomial multiplication naive O n2
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Polynomial multiplication naive O n2" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Polynomial multiplication naive O n2
