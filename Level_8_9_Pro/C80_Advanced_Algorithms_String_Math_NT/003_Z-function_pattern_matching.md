# Chapter: Z-function pattern matching
...
**Topic:** Z-function pattern matching
...
**Correctness proof sketch for Z-function pattern matching:**
...
```
ALGORITHM Z-FUNCTION_PATTERN_MATCHING(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Z-function pattern matching
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Z-function pattern matching" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Z-function pattern matching
