...
**Correctness proof sketch for Lagrange interpolation:**
...
```
ALGORITHM LAGRANGE_INTERPOLATION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Lagrange interpolation
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Lagrange interpolation" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Lagrange interpolation
