# Chapter: Polynomial truncated exp
...
**Topic:** Polynomial truncated exp
...
**Correctness proof sketch for Polynomial truncated exp:**
...
```
ALGORITHM POLYNOMIAL_TRUNCATED_EXP(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Polynomial truncated exp
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Polynomial truncated exp" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Polynomial truncated exp
