...
**Correctness proof sketch for DFT IDFT basics:**
...
```
ALGORITHM DFT_IDFT_BASICS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: DFT IDFT basics
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: DFT IDFT basics" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: DFT IDFT basics
