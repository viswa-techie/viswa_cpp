# Chapter: Lagrange interpolation O n log2 n
...
**Topic:** Lagrange interpolation O n log2 n
...
**Correctness proof sketch for Lagrange interpolation O n log2 n:**
...
```
ALGORITHM LAGRANGE_INTERPOLATION_O_N_LOG2_N(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Lagrange interpolation O n log2 n
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Lagrange interpolation O n log2 n" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Lagrange interpolation O n log2 n
