...
**Correctness proof sketch for SAM count substrings:**
...
```
ALGORITHM SAM_COUNT_SUBSTRINGS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: SAM count substrings
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: SAM count substrings" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: SAM count substrings
