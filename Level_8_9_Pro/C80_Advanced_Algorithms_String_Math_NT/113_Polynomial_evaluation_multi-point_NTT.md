# Chapter: Polynomial evaluation multi-point NTT
...
**Topic:** Polynomial evaluation multi-point NTT
...
**Correctness proof sketch for Polynomial evaluation multi-point NTT:**
...
```
ALGORITHM POLYNOMIAL_EVALUATION_MULTI-POINT_NTT(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Polynomial evaluation multi-point NTT
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Polynomial evaluation multi-point NTT" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Polynomial evaluation multi-point NTT
