# Chapter: Number of divisors function tau
...
**Topic:** Number of divisors function tau
...
**Correctness proof sketch for Number of divisors function tau:**
...
```
ALGORITHM NUMBER_OF_DIVISORS_FUNCTION_TAU(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Number of divisors function tau
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Number of divisors function tau" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Number of divisors function tau
