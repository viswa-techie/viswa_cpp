...
**Correctness proof sketch for Inclusion-exclusion principle:**
...
```
ALGORITHM INCLUSION-EXCLUSION_PRINCIPLE(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Inclusion-exclusion principle
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Inclusion-exclusion principle" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Inclusion-exclusion principle
