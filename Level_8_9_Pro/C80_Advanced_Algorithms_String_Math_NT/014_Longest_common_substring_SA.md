...
**Correctness proof sketch for Longest common substring SA:**
...
```
ALGORITHM LONGEST_COMMON_SUBSTRING_SA(input):
...
#include <iostream>
#include <vector>
// Competitive programming version for: Longest common substring SA
