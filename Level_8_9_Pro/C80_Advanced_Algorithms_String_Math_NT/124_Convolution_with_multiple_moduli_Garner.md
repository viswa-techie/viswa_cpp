# Chapter: Convolution with multiple moduli Garner
...
**Topic:** Convolution with multiple moduli Garner
...
**Correctness proof sketch for Convolution with multiple moduli Garner:**
...
```
ALGORITHM CONVOLUTION_WITH_MULTIPLE_MODULI_GARNER(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Convolution with multiple moduli Garner
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Convolution with multiple moduli Garner" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Convolution with multiple moduli Garner
