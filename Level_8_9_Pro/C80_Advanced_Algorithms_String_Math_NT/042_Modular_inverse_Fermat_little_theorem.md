# Chapter: Modular inverse Fermat little theorem
...
**Topic:** Modular inverse Fermat little theorem
...
**Correctness proof sketch for Modular inverse Fermat little theorem:**
...
```
ALGORITHM MODULAR_INVERSE_FERMAT_LITTLE_THEOREM(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Modular inverse Fermat little theorem
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Modular inverse Fermat little theorem" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Modular inverse Fermat little theorem
