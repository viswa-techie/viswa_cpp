# Chapter: Modular exponentiation fast power
...
**Topic:** Modular exponentiation fast power
...
**Correctness proof sketch for Modular exponentiation fast power:**
...
```
ALGORITHM MODULAR_EXPONENTIATION_FAST_POWER(input):
