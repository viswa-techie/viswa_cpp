# Chapter: Shortest pattern with period
...
**Topic:** Shortest pattern with period
...
**Correctness proof sketch for Shortest pattern with period:**
...
```
ALGORITHM SHORTEST_PATTERN_WITH_PERIOD(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Shortest pattern with period
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Shortest pattern with period" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Shortest pattern with period
