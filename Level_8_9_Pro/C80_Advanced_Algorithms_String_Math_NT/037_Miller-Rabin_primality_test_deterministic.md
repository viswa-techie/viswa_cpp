# Chapter: Miller-Rabin primality test deterministic
...
**Topic:** Miller-Rabin primality test deterministic
...
**Correctness proof sketch for Miller-Rabin primality test deterministic:**
...
```
ALGORITHM MILLER-RABIN_PRIMALITY_TEST_DETERMINISTIC(input):
