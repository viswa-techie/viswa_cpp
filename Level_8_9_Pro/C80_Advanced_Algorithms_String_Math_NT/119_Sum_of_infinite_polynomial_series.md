# Chapter: Sum of infinite polynomial series
...
**Topic:** Sum of infinite polynomial series
...
**Correctness proof sketch for Sum of infinite polynomial series:**
...
```
ALGORITHM SUM_OF_INFINITE_POLYNOMIAL_SERIES(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Sum of infinite polynomial series
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Sum of infinite polynomial series" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Sum of infinite polynomial series
