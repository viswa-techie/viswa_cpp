...
**Correctness proof sketch for Polynomial exp log:**
...
```
ALGORITHM POLYNOMIAL_EXP_LOG(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Polynomial exp log
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Polynomial exp log" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Polynomial exp log
