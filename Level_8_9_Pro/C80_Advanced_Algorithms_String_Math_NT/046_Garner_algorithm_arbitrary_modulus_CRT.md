# Chapter: Garner algorithm arbitrary modulus CRT
...
**Topic:** Garner algorithm arbitrary modulus CRT
...
**Correctness proof sketch for Garner algorithm arbitrary modulus CRT:**
...
```
ALGORITHM GARNER_ALGORITHM_ARBITRARY_MODULUS_CRT(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Garner algorithm arbitrary modulus CRT
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Garner algorithm arbitrary modulus CRT" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Garner algorithm arbitrary modulus CRT
