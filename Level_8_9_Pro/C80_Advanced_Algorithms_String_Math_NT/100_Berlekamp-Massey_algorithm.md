# Chapter: Berlekamp-Massey algorithm
...
**Topic:** Berlekamp-Massey algorithm
...
**Correctness proof sketch for Berlekamp-Massey algorithm:**
...
```
ALGORITHM BERLEKAMP-MASSEY_ALGORITHM(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Berlekamp-Massey algorithm
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Berlekamp-Massey algorithm" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Berlekamp-Massey algorithm
