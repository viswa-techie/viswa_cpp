# Chapter: Lexicographically smallest rotation
...
**Topic:** Lexicographically smallest rotation
...
**Correctness proof sketch for Lexicographically smallest rotation:**
...
```
ALGORITHM LEXICOGRAPHICALLY_SMALLEST_ROTATION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Lexicographically smallest rotation
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Lexicographically smallest rotation" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Lexicographically smallest rotation
