# Chapter: Stirling numbers 1st 2nd kind
...
**Topic:** Stirling numbers 1st 2nd kind
...
**Correctness proof sketch for Stirling numbers 1st 2nd kind:**
...
```
ALGORITHM STIRLING_NUMBERS_1ST_2ND_KIND(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Stirling numbers 1st 2nd kind
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Stirling numbers 1st 2nd kind" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Stirling numbers 1st 2nd kind
