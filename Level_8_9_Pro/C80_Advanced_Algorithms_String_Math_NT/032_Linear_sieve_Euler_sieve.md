# Chapter: Linear sieve Euler sieve
...
**Topic:** Linear sieve Euler sieve
...
**Correctness proof sketch for Linear sieve Euler sieve:**
...
```
ALGORITHM LINEAR_SIEVE_EULER_SIEVE(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Linear sieve Euler sieve
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Linear sieve Euler sieve" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Linear sieve Euler sieve
