# Chapter: FFT iterative bit-reversal permutation
...
**Topic:** FFT iterative bit-reversal permutation
...
**Correctness proof sketch for FFT iterative bit-reversal permutation:**
...
```
ALGORITHM FFT_ITERATIVE_BIT-REVERSAL_PERMUTATION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: FFT iterative bit-reversal permutation
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: FFT iterative bit-reversal permutation" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: FFT iterative bit-reversal permutation
