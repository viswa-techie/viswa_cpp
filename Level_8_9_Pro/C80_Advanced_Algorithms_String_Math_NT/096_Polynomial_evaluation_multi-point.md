# Chapter: Polynomial evaluation multi-point
...
**Topic:** Polynomial evaluation multi-point
...
**Correctness proof sketch for Polynomial evaluation multi-point:**
...
```
ALGORITHM POLYNOMIAL_EVALUATION_MULTI-POINT(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Polynomial evaluation multi-point
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Polynomial evaluation multi-point" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Polynomial evaluation multi-point
