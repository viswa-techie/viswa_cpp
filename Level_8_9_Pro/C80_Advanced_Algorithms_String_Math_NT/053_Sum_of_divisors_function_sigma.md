# Chapter: Sum of divisors function sigma
...
**Topic:** Sum of divisors function sigma
...
**Correctness proof sketch for Sum of divisors function sigma:**
...
```
ALGORITHM SUM_OF_DIVISORS_FUNCTION_SIGMA(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Sum of divisors function sigma
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Sum of divisors function sigma" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Sum of divisors function sigma
