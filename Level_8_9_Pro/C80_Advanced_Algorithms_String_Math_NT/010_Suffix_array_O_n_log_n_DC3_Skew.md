# Chapter: Suffix array O n log n DC3 Skew
...
**Topic:** Suffix array O n log n DC3 Skew
...
**Correctness proof sketch for Suffix array O n log n DC3 Skew:**
...
```
ALGORITHM SUFFIX_ARRAY_O_N_LOG_N_DC3_SKEW(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Suffix array O n log n DC3 Skew
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Suffix array O n log n DC3 Skew" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Suffix array O n log n DC3 Skew
