...
**Correctness proof sketch for Fermat little theorem:**
...
```
ALGORITHM FERMAT_LITTLE_THEOREM(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Fermat little theorem
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Fermat little theorem" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Fermat little theorem
