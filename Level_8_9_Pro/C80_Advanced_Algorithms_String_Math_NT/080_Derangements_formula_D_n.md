# Chapter: Derangements formula D n
...
**Topic:** Derangements formula D n
...
**Correctness proof sketch for Derangements formula D n:**
...
```
ALGORITHM DERANGEMENTS_FORMULA_D_N(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Derangements formula D n
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Derangements formula D n" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Derangements formula D n
