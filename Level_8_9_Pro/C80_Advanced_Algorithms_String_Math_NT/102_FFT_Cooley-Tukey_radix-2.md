# Chapter: FFT Cooley-Tukey radix-2
...
**Topic:** FFT Cooley-Tukey radix-2
...
**Correctness proof sketch for FFT Cooley-Tukey radix-2:**
...
```
ALGORITHM FFT_COOLEY-TUKEY_RADIX-2(input):
