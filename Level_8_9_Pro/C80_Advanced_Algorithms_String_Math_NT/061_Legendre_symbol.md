...
**Correctness proof sketch for Legendre symbol:**
...
```
ALGORITHM LEGENDRE_SYMBOL(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Legendre symbol
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Legendre symbol" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Legendre symbol
