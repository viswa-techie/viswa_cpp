...
**Correctness proof sketch for SAM longest common substring:**
...
```
ALGORITHM SAM_LONGEST_COMMON_SUBSTRING(input):
...
#include <iostream>
#include <vector>
// Competitive programming version for: SAM longest common substring
