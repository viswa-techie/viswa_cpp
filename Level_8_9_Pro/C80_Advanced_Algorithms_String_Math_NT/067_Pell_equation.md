...
**Correctness proof sketch for Pell equation:**
...
#include <iostream>
#include <vector>
// Production implementation template for: Pell equation
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Pell equation" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Pell equation
