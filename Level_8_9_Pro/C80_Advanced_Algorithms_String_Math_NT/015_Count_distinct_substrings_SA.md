...
**Correctness proof sketch for Count distinct substrings SA:**
...
```
ALGORITHM COUNT_DISTINCT_SUBSTRINGS_SA(input):
...
#include <iostream>
#include <vector>
// Competitive programming version for: Count distinct substrings SA
