# Chapter: NTT prime choice 998244353
...
**Topic:** NTT prime choice 998244353
...
**Correctness proof sketch for NTT prime choice 998244353:**
...
```
ALGORITHM NTT_PRIME_CHOICE_998244353(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: NTT prime choice 998244353
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: NTT prime choice 998244353" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: NTT prime choice 998244353
