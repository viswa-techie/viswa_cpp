...
**Correctness proof sketch for Formal Laurent series:**
...
```
ALGORITHM FORMAL_LAURENT_SERIES(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Formal Laurent series
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Formal Laurent series" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Formal Laurent series
