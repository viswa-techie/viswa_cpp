# Chapter: Longest repeated substring
...
**Topic:** Longest repeated substring
...
**Correctness proof sketch for Longest repeated substring:**
...
```
ALGORITHM LONGEST_REPEATED_SUBSTRING(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Longest repeated substring
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Longest repeated substring" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Longest repeated substring
