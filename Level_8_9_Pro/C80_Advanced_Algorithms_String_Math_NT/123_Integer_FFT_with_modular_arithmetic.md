# Chapter: Integer FFT with modular arithmetic
...
**Topic:** Integer FFT with modular arithmetic
...
**Correctness proof sketch for Integer FFT with modular arithmetic:**
...
```
ALGORITHM INTEGER_FFT_WITH_MODULAR_ARITHMETIC(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Integer FFT with modular arithmetic
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Integer FFT with modular arithmetic" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Integer FFT with modular arithmetic
