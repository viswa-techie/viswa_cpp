# Chapter: Rabin-Karp multi-pattern matching
...
**Topic:** Rabin-Karp multi-pattern matching
...
**Correctness proof sketch for Rabin-Karp multi-pattern matching:**
...
```
ALGORITHM RABIN-KARP_MULTI-PATTERN_MATCHING(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Rabin-Karp multi-pattern matching
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Rabin-Karp multi-pattern matching" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Rabin-Karp multi-pattern matching
