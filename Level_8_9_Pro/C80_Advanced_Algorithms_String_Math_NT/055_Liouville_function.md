...
**Correctness proof sketch for Liouville function:**
...
```
ALGORITHM LIOUVILLE_FUNCTION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Liouville function
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Liouville function" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Liouville function
