# Chapter: Tonelli-Shanks square root mod p
...
**Topic:** Tonelli-Shanks square root mod p
...
**Correctness proof sketch for Tonelli-Shanks square root mod p:**
...
```
ALGORITHM TONELLI-SHANKS_SQUARE_ROOT_MOD_P(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Tonelli-Shanks square root mod p
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Tonelli-Shanks square root mod p" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Tonelli-Shanks square root mod p
