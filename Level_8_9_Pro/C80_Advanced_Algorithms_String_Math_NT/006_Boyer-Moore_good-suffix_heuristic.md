# Chapter: Boyer-Moore good-suffix heuristic
...
**Topic:** Boyer-Moore good-suffix heuristic
...
**Correctness proof sketch for Boyer-Moore good-suffix heuristic:**
...
```
ALGORITHM BOYER-MOORE_GOOD-SUFFIX_HEURISTIC(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Boyer-Moore good-suffix heuristic
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Boyer-Moore good-suffix heuristic" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Boyer-Moore good-suffix heuristic
