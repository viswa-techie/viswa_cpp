# Chapter: Bitap algorithm shift-or shift-and
...
**Topic:** Bitap algorithm shift-or shift-and
...
**Correctness proof sketch for Bitap algorithm shift-or shift-and:**
...
```
ALGORITHM BITAP_ALGORITHM_SHIFT-OR_SHIFT-AND(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Bitap algorithm shift-or shift-and
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Bitap algorithm shift-or shift-and" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Bitap algorithm shift-or shift-and
