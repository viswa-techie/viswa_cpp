...
**Correctness proof sketch for Jacobi symbol:**
...
#include <iostream>
#include <vector>
// Production implementation template for: Jacobi symbol
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Jacobi symbol" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Jacobi symbol
