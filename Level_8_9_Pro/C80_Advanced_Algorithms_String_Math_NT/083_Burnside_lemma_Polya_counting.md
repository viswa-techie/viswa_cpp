# Chapter: Burnside lemma Polya counting
...
**Topic:** Burnside lemma Polya counting
...
**Correctness proof sketch for Burnside lemma Polya counting:**
...
```
ALGORITHM BURNSIDE_LEMMA_POLYA_COUNTING(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Burnside lemma Polya counting
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Burnside lemma Polya counting" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Burnside lemma Polya counting
