# Chapter: nCr mod p Lucas theorem
...
**Correctness proof sketch for nCr mod p Lucas theorem:**
...
```
ALGORITHM NCR_MOD_P_LUCAS_THEOREM(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: nCr mod p Lucas theorem
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: nCr mod p Lucas theorem" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: nCr mod p Lucas theorem
