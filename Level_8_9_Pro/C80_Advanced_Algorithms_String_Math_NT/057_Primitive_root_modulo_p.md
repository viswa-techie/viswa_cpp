# Chapter: Primitive root modulo p
...
**Correctness proof sketch for Primitive root modulo p:**
...
```
ALGORITHM PRIMITIVE_ROOT_MODULO_P(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Primitive root modulo p
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Primitive root modulo p" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Primitive root modulo p
