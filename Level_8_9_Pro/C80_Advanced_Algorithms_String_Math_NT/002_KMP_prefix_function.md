...
**Correctness proof sketch for KMP prefix function:**
...
```
ALGORITHM KMP_PREFIX_FUNCTION(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: KMP prefix function
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: KMP prefix function" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: KMP prefix function
