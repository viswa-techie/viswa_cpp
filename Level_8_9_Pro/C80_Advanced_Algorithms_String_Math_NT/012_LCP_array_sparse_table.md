# Chapter: LCP array sparse table
...
**Correctness proof sketch for LCP array sparse table:**
...
```
ALGORITHM LCP_ARRAY_SPARSE_TABLE(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: LCP array sparse table
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: LCP array sparse table" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: LCP array sparse table
