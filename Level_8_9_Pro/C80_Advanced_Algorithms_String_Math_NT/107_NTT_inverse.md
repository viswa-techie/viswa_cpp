...
**Correctness proof sketch for NTT inverse:**
...
#include <iostream>
#include <vector>
// Production implementation template for: NTT inverse
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: NTT inverse" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: NTT inverse
