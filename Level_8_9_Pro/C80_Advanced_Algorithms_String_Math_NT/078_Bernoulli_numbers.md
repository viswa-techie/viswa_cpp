...
**Correctness proof sketch for Bernoulli numbers:**
...
```
ALGORITHM BERNOULLI_NUMBERS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Bernoulli numbers
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Bernoulli numbers" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Bernoulli numbers
