# Chapter: Generating functions basics
...
**Topic:** Generating functions basics
...
**Correctness proof sketch for Generating functions basics:**
...
```
ALGORITHM GENERATING_FUNCTIONS_BASICS(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Generating functions basics
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Generating functions basics" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Generating functions basics
