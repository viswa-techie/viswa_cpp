# Chapter: Aho-Corasick multi-string search
...
**Topic:** Aho-Corasick multi-string search
...
**Correctness proof sketch for Aho-Corasick multi-string search:**
...
```
ALGORITHM AHO-CORASICK_MULTI-STRING_SEARCH(input):
