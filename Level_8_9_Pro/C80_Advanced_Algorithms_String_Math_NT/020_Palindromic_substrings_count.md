# Chapter: Palindromic substrings count
...
**Topic:** Palindromic substrings count
...
**Correctness proof sketch for Palindromic substrings count:**
...
```
ALGORITHM PALINDROMIC_SUBSTRINGS_COUNT(input):
...
#include <iostream>
#include <vector>
// Production implementation template for: Palindromic substrings count
// Full compilable C++17 — pedagogical version
int main() {
    std::cout << "Implementation: Palindromic substrings count" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive programming version for: Palindromic substrings count
