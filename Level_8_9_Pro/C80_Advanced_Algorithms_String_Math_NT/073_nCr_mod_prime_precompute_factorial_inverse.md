# Chapter: nCr mod prime precompute factorial inverse
...
**Topic:** nCr mod prime precompute factorial inverse
...
**Correctness proof sketch for nCr mod prime precompute factorial inverse:**
...
```
ALGORITHM NCR_MOD_PRIME_PRECOMPUTE_FACTORIAL_INVERSE(input):
