# Chapter: Sieve of Eratosthenes optimized
...
**Topic:** Sieve of Eratosthenes optimized
...
**Correctness proof sketch for Sieve of Eratosthenes optimized:**
...
```
ALGORITHM SIEVE_OF_ERATOSTHENES_OPTIMIZED(input):
