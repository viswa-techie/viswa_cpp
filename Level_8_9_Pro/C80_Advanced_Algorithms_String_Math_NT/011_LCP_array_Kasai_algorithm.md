...
**Correctness proof sketch for LCP array Kasai algorithm:**
...
```
ALGORITHM LCP_ARRAY_KASAI_ALGORITHM(input):
...
#include <iostream>
#include <vector>
// Competitive programming version for: LCP array Kasai algorithm
