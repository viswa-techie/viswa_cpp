# Chapter: C++23 features overview deducing this expected flat_map print
...
**Topic:** C++23 features overview deducing this expected flat_map print
...
**In one paragraph:** C++23 brings deducing `this` (explicit object parameter), `std::expected<T,E>`, `std::flat_map`, `std::print`, `std::generator`, and more.
