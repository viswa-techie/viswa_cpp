# Chapter: Clang-Tidy check writing
...
**Topic:** Clang-Tidy check writing
...
```cpp
#include <iostream>
// Research-level implementation template for: Clang-Tidy check writing
...
int main() {
    std::cout << "Topic: Clang-Tidy check writing" << std::endl;
    return 0;
}
```
...
```cpp
#include <iostream>
// Alternative perspective / comparison for: Clang-Tidy check writing
...
**In one paragraph:** This chapter covers **Clang-Tidy check writing** — a research-level topic in Compiler Internals.
