# Chapter: SSA form Static Single Assignment
...
**Topic:** SSA form Static Single Assignment
...
**In one paragraph:** SSA: every variable is assigned exactly once. Multiple assignments use phi nodes at control flow merge points. Enables powerful optimizations.
