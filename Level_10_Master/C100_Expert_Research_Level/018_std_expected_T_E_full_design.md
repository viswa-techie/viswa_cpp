# Chapter: std expected T E full design
...
**Topic:** std expected T E full design
...
**In one paragraph:** std::expected<T,E>: monadic error handling without exceptions. Like Rust's Result<T,E>.
