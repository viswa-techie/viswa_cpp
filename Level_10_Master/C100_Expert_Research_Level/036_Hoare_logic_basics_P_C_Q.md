# Chapter: Hoare logic basics P C Q
...
**Topic:** Hoare logic basics P C Q
...
**In one paragraph:** Hoare logic: {P} C {Q} means "if precondition P holds before executing command C, then postcondition Q holds after." Foundation of program verification.
