...
```cpp
#include <iostream>
// Research-level implementation template for: Liveness analysis
...
int main() {
    std::cout << "Topic: Liveness analysis" << std::endl;
    return 0;
}
```
...
```cpp
#include <iostream>
// Alternative perspective / comparison for: Liveness analysis
...
**In one paragraph:** This chapter covers **Liveness analysis** — a research-level topic in Compiler Internals.
