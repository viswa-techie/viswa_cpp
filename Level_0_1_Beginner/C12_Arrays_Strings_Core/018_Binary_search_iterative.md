...
Write a C++ program that solves the Binary search iterative problem.
...
### What Is It?
Binary search iterative is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of binary search iterative as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    ...
    // Test not found
    std::cout << "99 search: " << binarySearch(arr, 99) << "";  // -1
    return 0;
}
```
...
- Binary search iterative demonstrates loop control and algorithmic thinking
...
- **Core idea:** Binary search iterative
- **Key construct:** Loops
