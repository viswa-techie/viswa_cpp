...
Write a C++ program that solves the Stable sort vs unstable problem.
...
### What Is It?
Stable sort vs unstable is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of stable sort vs unstable as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    // Implementation: Stable sort vs unstable
    std::cout << "Demonstrating: Stable sort vs unstable
";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Stable sort vs unstable
...
/*
 * Stable sort vs unstable — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Stable sort vs unstable — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
- Stable sort vs unstable demonstrates loop control and algorithmic thinking
...
- **Core idea:** Stable sort vs unstable
- **Key construct:** Loops
