...
Write a C++ program that solves the Bucket sort problem.
...
### What Is It?
Bucket sort is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of bucket sort as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    ...
    std::cout << "Demonstrating: Bucket sort
";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Bucket sort
...
/*
 * Bucket sort — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Bucket sort — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
- Bucket sort demonstrates loop control and algorithmic thinking
