...
Write a C++ program that solves the Radix sort problem.
...
### What Is It?
Radix sort is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of radix sort as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    ...
    std::cout << "Demonstrating: Radix sort";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Radix sort
...
/*
 * Radix sort — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Radix sort — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
- Radix sort demonstrates loop control and algorithmic thinking
