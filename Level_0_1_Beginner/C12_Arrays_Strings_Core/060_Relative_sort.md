...
Write a C++ program that solves the Relative sort problem.
...
### What Is It?
Relative sort is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of relative sort as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    // Implementation: Relative sort
    std::cout << "Demonstrating: Relative sort";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Relative sort
...
/*
 * Relative sort — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Relative sort — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
- Relative sort demonstrates loop control and algorithmic thinking
