...
Write a C++ program that solves the Count distinct in window problem.
...
### What Is It?
Count distinct in window is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of count distinct in window as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    // Implementation: Count distinct in window
    std::cout << "Demonstrating: Count distinct in window
";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Count distinct in window
...
/*
 * Count distinct in window — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Count distinct in window — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
- Count distinct in window demonstrates loop control and algorithmic thinking
...
- **Core idea:** Count distinct in window
- **Key construct:** Loops
