...
Write a C++ program that solves the Custom comparator sort problem.
...
### What Is It?
Custom comparator sort is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of custom comparator sort as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    // Implementation: Custom comparator sort
    std::cout << "Demonstrating: Custom comparator sort";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Custom comparator sort
...
/*
 * Custom comparator sort — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Custom comparator sort — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
- Custom comparator sort demonstrates loop control and algorithmic thinking
...
- **Core idea:** Custom comparator sort
- **Key construct:** Loops
