...
Write a C++ program that solves the Subarray with given sum problem.
...
### What Is It?
Subarray with given sum is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of subarray with given sum as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    // Implementation: Subarray with given sum
    std::cout << "Demonstrating: Subarray with given sum
";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Subarray with given sum
...
/*
 * Subarray with given sum — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Subarray with given sum — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
- Subarray with given sum demonstrates loop control and algorithmic thinking
...
- **Core idea:** Subarray with given sum
- **Key construct:** Loops
