...
int main() {
    ...
    std::cout << "Demonstrating: Jump game II min jumps
";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Jump game II min jumps
...
/*
 * Jump game II min jumps — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Jump game II min jumps — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
