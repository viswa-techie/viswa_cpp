...
Write a C++ program that solves the Find all anagrams in string problem.
...
### What Is It?
Find all anagrams in string is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of find all anagrams in string as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    // Implementation: Find all anagrams in string
    std::cout << "Demonstrating: Find all anagrams in string";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Find all anagrams in string
...
/*
 * Find all anagrams in string — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Find all anagrams in string — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
- Find all anagrams in string demonstrates loop control and algorithmic thinking
...
- **Core idea:** Find all anagrams in string
- **Key construct:** Loops
