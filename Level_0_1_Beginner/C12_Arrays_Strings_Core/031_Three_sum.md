...
Write a C++ program that solves the Three sum problem.
...
### What Is It?
Three sum is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of three sum as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    // Implementation: Three sum
    std::cout << "Demonstrating: Three sum
";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Three sum
...
/*
 * Three sum — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Three sum — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
- Three sum demonstrates loop control and algorithmic thinking
