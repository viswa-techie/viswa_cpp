 ...
 */
int main() {
    // TODO: Implement Out-of-bounds access (UB)
    // Step 1: Read input
    // Step 2: Process
    // Step 3: Output result
    
    std::cout << "Solution for: Out-of-bounds access (UB)" << std::endl;
    return 0;
}
```
...
/*
 * Out-of-bounds access (UB) — Optimized approach using STL
 * 
...
/*
 * Out-of-bounds access (UB) — Modern C++ approach
 * 
