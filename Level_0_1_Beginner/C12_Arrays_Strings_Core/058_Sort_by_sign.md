...
int main() {
    // Implementation: Sort by sign
    std::cout << "Demonstrating: Sort by sign
";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Sort by sign
...
/*
 * Sort by sign — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Sort by sign — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
