...
Write a C++ program that solves the Merge two sorted arrays (in-place) problem.
...
### What Is It?
Merge two sorted arrays (in-place) is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of merge two sorted arrays (in-place) as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    // Implementation: Merge two sorted arrays in place
    std::cout << "Demonstrating: Merge two sorted arrays in place
";
    
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Core logic for Merge two sorted arrays in place
...
/*
 * Merge two sorted arrays in place — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
/*
 * Merge two sorted arrays in place — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
...
- Merge two sorted arrays (in-place) demonstrates loop control and algorithmic thinking
...
- **Core idea:** Merge two sorted arrays (in-place)
- **Key construct:** Loops
