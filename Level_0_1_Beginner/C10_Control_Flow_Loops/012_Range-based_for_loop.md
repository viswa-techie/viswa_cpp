...
Master the use of Range-based for loop in C++ programs. Understand when and why to use it.
...
### What Is It?
Range-based for loop is a technique in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of range-based for loop as a tool in your toolbox — know when to reach for it.
...
/*
 * Range based for loop — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Using STL algorithms for Range based for loop
...
/*
 * Range based for loop — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Modern C++ approach for: Range based for loop
...
- Range-based for loop demonstrates proper C++ idioms and best practices
...
- **Core idea:** Range-based for loop
