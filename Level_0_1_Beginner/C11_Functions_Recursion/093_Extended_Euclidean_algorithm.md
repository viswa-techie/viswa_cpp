...
int main() {
    ...
    std::cout << "Solution for: Extended Euclidean algorithm" << std::endl;
    return 0;
}
```
...
/*
 * Extended Euclidean algorithm — Optimized approach using STL
 * 
...
/*
 * Extended Euclidean algorithm — Modern C++ approach
 * 
