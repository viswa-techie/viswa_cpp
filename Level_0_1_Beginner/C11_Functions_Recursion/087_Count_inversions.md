...
Write a C++ program that solves the Count inversions problem.
...
### What Is It?
Count inversions is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of count inversions as a puzzle — break it into smaller pieces and solve each one.
...
int main() {
    // Implementation: Count inversions
    std::cout << "Demonstrating: Count inversions";
...
/*
 * Count inversions — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // STL-based implementation of Count inversions
    std::sort(data.begin(), data.end());
...
/*
 * Count inversions — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Modern C++ features for Count inversions
...
- Count inversions demonstrates loop control and algorithmic thinking
...
## Key Takeaways
1. Understand the core pattern and when to apply Count inversions
