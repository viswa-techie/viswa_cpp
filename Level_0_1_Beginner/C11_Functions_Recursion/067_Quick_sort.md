...
Write a C++ program that solves the Quick sort problem.
...
### What Is It?
Quick sort is a classic problem in C++ that appears frequently in interviews and real projects.
...
### Mental Model
Think of quick sort as a puzzle — break it into smaller pieces and solve each one.
...
/*
 * Quick sort — STL/Library approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // STL-based implementation of Quick sort
...
/*
 * Quick sort — Modern C++17/20 approach
 */
int main() {
    std::vector<int> data = {5, 2, 8, 1, 9, 3, 7, 4, 6};
    
    // Modern C++ features for Quick sort
...
- Quick sort demonstrates loop control and algorithmic thinking
