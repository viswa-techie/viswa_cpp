# Chapter: Merge K sorted linked lists
...
## 1. Problem Statement
Master the topic: **Merge K sorted linked lists**.
...
Min-heap of (value, list-iterator). Pop and advance.
...
- **Core idea:** Merge K sorted linked lists — Heap / Priority Queue + Sorting.
