# Chapter: K closest points to origin
...
## 1. Problem Statement
Master the topic: **K closest points to origin**.
...
Max-heap of size k, sorted by squared distance.
...
- **Core idea:** K closest points to origin — Heap / Priority Queue + Sorting.
