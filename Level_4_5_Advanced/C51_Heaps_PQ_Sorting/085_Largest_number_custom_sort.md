# Chapter: Largest number custom sort
...
## 1. Problem Statement
Master the topic: **Largest number custom sort**.
...
Sort strings with custom comparator: a+b > b+a means a comes first.
...
- **Core idea:** Largest number custom sort — Heap / Priority Queue + Sorting.
