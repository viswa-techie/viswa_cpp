# Chapter: Inversion count merge sort
...
## 1. Problem Statement
Master the topic: **Inversion count merge sort**.
...
During merge, when right element placed before left elements, count remaining left as inversions.
...
- **Core idea:** Inversion count merge sort — Heap / Priority Queue + Sorting.
