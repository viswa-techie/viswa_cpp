...
## 1. Problem Statement
Master the topic: **Diameter of tree**.
...
Diameter = max over all nodes of (left height + right height). Compute heights bottom-up.
...
- **Core idea:** Diameter of tree — Tree DFS / BST property.
