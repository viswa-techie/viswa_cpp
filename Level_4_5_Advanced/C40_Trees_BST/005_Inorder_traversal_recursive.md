# Chapter: Inorder traversal recursive
...
## 1. Problem Statement
Master the topic: **Inorder traversal recursive**.
...
Visit left subtree, root, then right subtree (LNR). Recursive form is the cleanest.
...
- **Core idea:** Inorder traversal recursive — Tree DFS / BST property.
