...
## 1. Problem Statement
Master the topic: **LCA binary tree**.
...
Post-order: if root matches p or q, return root. Otherwise return non-null child or null.
...
- **Core idea:** LCA binary tree — Tree DFS / BST property.
