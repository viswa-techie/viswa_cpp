...
## 1. Problem Statement
Master the topic: **Kth smallest in BST**.
...
Inorder traversal yields sorted order — stop at kth.
...
- **Core idea:** Kth smallest in BST — Tree DFS / BST property.
