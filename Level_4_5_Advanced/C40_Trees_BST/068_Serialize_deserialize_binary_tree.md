# Chapter: Serialize deserialize binary tree
...
## 1. Problem Statement
Master the topic: **Serialize deserialize binary tree**.
...
Pre-order with null markers. Use stringstream for parsing.
...
- **Core idea:** Serialize deserialize binary tree — Tree DFS / BST property.
