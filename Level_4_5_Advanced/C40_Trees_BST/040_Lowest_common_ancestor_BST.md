# Chapter: Lowest common ancestor BST
...
## 1. Problem Statement
Master the topic: **Lowest common ancestor BST**.
...
BST property: LCA is the first node where p and q split (one in each subtree).
...
- **Core idea:** Lowest common ancestor BST — Tree DFS / BST property.
