...
## 1. Problem Statement
Master the topic: **Level order traversal**.
...
BFS using a queue. Track level boundaries by recording size at start of each level.
...
- **Core idea:** Level order traversal — Tree DFS / BST property.
