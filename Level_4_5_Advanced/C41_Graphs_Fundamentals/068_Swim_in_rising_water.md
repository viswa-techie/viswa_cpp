...
This problem exercises **Swim in rising water** — a core technique in Graphs — Fundamentals & Traversal.
...
- **Core idea:** Swim in rising water — Graph traversal (BFS/DFS) + Union-Find.
