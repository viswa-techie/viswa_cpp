# Chapter: Topological sort Kahn BFS
...
## 1. Problem Statement
Master the topic: **Topological sort Kahn BFS**.
...
Repeatedly take a node with in-degree 0; reduces neighbors' in-degree.
...
- **Core idea:** Topological sort Kahn BFS — Graph traversal (BFS/DFS) + Union-Find.
