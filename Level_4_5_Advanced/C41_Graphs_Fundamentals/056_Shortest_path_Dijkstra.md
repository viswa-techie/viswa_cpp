# Chapter: Shortest path Dijkstra
...
## 1. Problem Statement
Master the topic: **Shortest path Dijkstra**.
...
Greedy with min-heap. For each popped node, relax outgoing edges.
...
- **Core idea:** Shortest path Dijkstra — Graph traversal (BFS/DFS) + Union-Find.
