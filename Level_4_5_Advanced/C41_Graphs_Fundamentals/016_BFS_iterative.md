...
## 1. Problem Statement
Master the topic: **BFS iterative**.
...
Standard graph BFS with queue + visited set.
...
- **Core idea:** BFS iterative — Graph traversal (BFS/DFS) + Union-Find.
