...
## 1. Problem Statement
Master the topic: **Course schedule II**.
...
Topological sort. If any course remains with non-zero in-degree, cycle exists.
...
- **Core idea:** Course schedule II — Graph traversal (BFS/DFS) + Union-Find.
