...
## 1. Problem Statement
Master the topic: **MST Prim algorithm**.
...
Grow tree from arbitrary start; always add min-weight edge crossing the cut. Uses min-heap.
...
- **Core idea:** MST Prim algorithm — Graph traversal (BFS/DFS) + Union-Find.
