...
## 1. Problem Statement
Master the topic: **MST Kruskal algorithm**.
...
Sort edges by weight; pick if endpoints in different components (Union-Find).
...
- **Core idea:** MST Kruskal algorithm — Graph traversal (BFS/DFS) + Union-Find.
