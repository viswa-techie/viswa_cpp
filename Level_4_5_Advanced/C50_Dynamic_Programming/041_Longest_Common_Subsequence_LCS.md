...
## 1. Problem Statement
Master the topic: **Longest Common Subsequence LCS**.
...
dp[i][j] = LCS of a[0..i-1], b[0..j-1]. If chars match: dp[i-1][j-1]+1, else max.
...
- **Core idea:** Longest Common Subsequence LCS — Dynamic Programming.
