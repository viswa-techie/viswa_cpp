# Chapter: Palindrome partitioning min cuts
...
## 1. Problem Statement
Master the topic: **Palindrome partitioning min cuts**.
...
dp[i] = min cuts for s[0..i]. Precompute palindrome table.
...
- **Core idea:** Palindrome partitioning min cuts — Dynamic Programming.
