...
## 1. Problem Statement
Master the topic: **Stock with cooldown**.
...
3 states: hold, sold, rest. Transition based on price.
...
- **Core idea:** Stock with cooldown — Dynamic Programming.
