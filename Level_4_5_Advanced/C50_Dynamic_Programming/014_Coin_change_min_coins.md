...
## 1. Problem Statement
Master the topic: **Coin change min coins**.
...
dp[v] = min coins to make value v. dp[v] = min(dp[v-c]+1) over coins c.
...
- **Core idea:** Coin change min coins — Dynamic Programming.
