# Chapter: Partition equal subset sum
...
## 1. Problem Statement
Master the topic: **Partition equal subset sum**.
...
Sum must be even. Then 0-1 knapsack: can subset sum = total/2?
...
- **Core idea:** Partition equal subset sum — Dynamic Programming.
