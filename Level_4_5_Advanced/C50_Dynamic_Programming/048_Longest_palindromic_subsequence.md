# Chapter: Longest palindromic subsequence
...
## 1. Problem Statement
Master the topic: **Longest palindromic subsequence**.
...
LCS of s and reverse(s). Or interval DP: dp[i][j] = longest pal in s[i..j].
...
- **Core idea:** Longest palindromic subsequence — Dynamic Programming.
