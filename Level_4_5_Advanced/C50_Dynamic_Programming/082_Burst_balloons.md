...
## 1. Problem Statement
Master the topic: **Burst balloons**.
...
Reverse-think: which balloon to burst LAST in interval (i,j). dp[i][j] over (i,j) open intervals.
...
- **Core idea:** Burst balloons — Dynamic Programming.
