# Chapter: Longest increasing subsequence O n log n
...
## 1. Problem Statement
Master the topic: **Longest increasing subsequence O n log n**.
...
Patience sorting: maintain `tails` array; binary search insertion point.
...
- **Core idea:** Longest increasing subsequence O n log n — Dynamic Programming.
