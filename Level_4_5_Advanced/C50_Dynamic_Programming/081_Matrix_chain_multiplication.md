...
## 1. Problem Statement
Master the topic: **Matrix chain multiplication**.
...
Interval DP: dp[i][j] = min cost to multiply matrices i..j. Try every split point.
...
- **Core idea:** Matrix chain multiplication — Dynamic Programming.
