# Chapter: Segment tree with max min
...
**Topic:** Segment tree with max min
...
**Key theorem/property for Segment tree with max min:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Segment tree with max min
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Segment tree with max min" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Segment tree with max min
int main() {
    // Fast I/O
