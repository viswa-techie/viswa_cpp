# Chapter: Suffix automaton SAM build
...
**Topic:** Suffix automaton SAM build
...
**Key theorem/property for Suffix automaton SAM build:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Suffix automaton SAM build
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Suffix automaton SAM build" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Suffix automaton SAM build
int main() {
    // Fast I/O
