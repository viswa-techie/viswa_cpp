# Chapter: SAM count distinct substrings
...
**Topic:** SAM count distinct substrings
...
**Key theorem/property for SAM count distinct substrings:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: SAM count distinct substrings
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: SAM count distinct substrings" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: SAM count distinct substrings
int main() {
    // Fast I/O
