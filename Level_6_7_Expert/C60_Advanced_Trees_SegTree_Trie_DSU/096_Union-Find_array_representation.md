# Chapter: Union-Find array representation
...
**Topic:** Union-Find array representation
...
**Key theorem/property for Union-Find array representation:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Union-Find array representation
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Union-Find array representation" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Union-Find array representation
int main() {
    // Fast I/O
