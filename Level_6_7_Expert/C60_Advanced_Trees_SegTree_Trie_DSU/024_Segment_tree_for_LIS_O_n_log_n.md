# Chapter: Segment tree for LIS O n log n
...
**Topic:** Segment tree for LIS O n log n
...
**Key theorem/property for Segment tree for LIS O n log n:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Segment tree for LIS O n log n
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Segment tree for LIS O n log n" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Segment tree for LIS O n log n
int main() {
    // Fast I/O
