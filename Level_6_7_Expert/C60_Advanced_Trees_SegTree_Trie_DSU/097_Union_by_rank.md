...
**Key theorem/property for Union by rank:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Union by rank
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Union by rank" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Union by rank
int main() {
    // Fast I/O
