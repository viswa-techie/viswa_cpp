...
**Key theorem/property for Union by size:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Union by size
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Union by size" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Union by size
int main() {
    // Fast I/O
