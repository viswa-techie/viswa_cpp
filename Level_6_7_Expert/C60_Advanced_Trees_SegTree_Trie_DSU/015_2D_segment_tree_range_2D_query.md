# Chapter: 2D segment tree range 2D query
...
**Topic:** 2D segment tree range 2D query
...
**Key theorem/property for 2D segment tree range 2D query:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: 2D segment tree range 2D query
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: 2D segment tree range 2D query" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: 2D segment tree range 2D query
int main() {
    // Fast I/O
