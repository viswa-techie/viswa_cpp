# Chapter: Longest repeated substring SA LCP
...
**Topic:** Longest repeated substring SA LCP
...
**Key theorem/property for Longest repeated substring SA LCP:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Longest repeated substring SA LCP
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Longest repeated substring SA LCP" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Longest repeated substring SA LCP
int main() {
    // Fast I/O
