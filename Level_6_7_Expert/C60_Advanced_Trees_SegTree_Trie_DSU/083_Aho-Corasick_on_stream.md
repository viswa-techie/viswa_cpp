# Chapter: Aho-Corasick on stream
...
**Key theorem/property for Aho-Corasick on stream:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Aho-Corasick on stream
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Aho-Corasick on stream" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Aho-Corasick on stream
int main() {
    // Fast I/O
