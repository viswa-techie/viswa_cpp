...
**Key theorem/property for BIT 2D prefix sums:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: BIT 2D prefix sums
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: BIT 2D prefix sums" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: BIT 2D prefix sums
int main() {
    // Fast I/O
