# Chapter: Online string matching
...
**Key theorem/property for Online string matching:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Online string matching
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Online string matching" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Online string matching
int main() {
    // Fast I/O
