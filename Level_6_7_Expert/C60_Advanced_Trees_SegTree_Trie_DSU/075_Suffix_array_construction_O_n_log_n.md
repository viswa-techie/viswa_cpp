# Chapter: Suffix array construction O n log n
...
**Topic:** Suffix array construction O n log n
...
**Key theorem/property for Suffix array construction O n log n:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Suffix array construction O n log n
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Suffix array construction O n log n" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Suffix array construction O n log n
int main() {
    // Fast I/O
