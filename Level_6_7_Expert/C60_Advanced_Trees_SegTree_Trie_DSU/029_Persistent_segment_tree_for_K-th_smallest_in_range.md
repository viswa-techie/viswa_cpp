# Chapter: Persistent segment tree for K-th smallest in range

> **Level:** 6 | **Category:** C60 — Advanced Trees (Segment Tree, Fenwick, Trie, DSU)

---

## 1. Formal Problem Definition
**Topic:** Persistent segment tree for K-th smallest in range
...
Based on divide-and-conquer over index ranges (segment tree) or binary representations (BIT). Tries exploit prefix sharing. String algorithms leverage border theory (KMP/Z) or suffix structure.

**Key theorem/property for Persistent segment tree for K-th smallest in range:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Persistent segment tree for K-th smallest in range
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Persistent segment tree for K-th smallest in range" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Persistent segment tree for K-th smallest in range
int main() {
    // Fast I/O
...
Segment tree: 4n array, cache-friendly. BIT: 1-indexed array, extremely cache-friendly. Trie: pointer-heavy, poor cache. Consider flat arrays with hashing for better locality.
...
- Builds upon: arrays, recursion, divide-and-conquer
- Used by: Heavy-light decomposition, persistent DS, centroid decomposition
- Real systems: databases (B-tree), text editors (rope/segment tree)

---

## 10. Competitive Programming Applications
Segment tree is the most-used advanced DS in competitive programming. BIT for simpler problems. Suffix array + LCP solves most string problems at ICPC/CF.
...
- **System design connection:** Log-structured merge trees use similar ideas
...
**When to use:** Range Query / Prefix Structure / String Automaton pattern — whenever you need O(log n) range operations on a sequence.
