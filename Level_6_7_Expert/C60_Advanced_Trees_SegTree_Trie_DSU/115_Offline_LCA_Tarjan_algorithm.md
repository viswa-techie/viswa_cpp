# Chapter: Offline LCA Tarjan algorithm
...
**Topic:** Offline LCA Tarjan algorithm
...
**Key theorem/property for Offline LCA Tarjan algorithm:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Offline LCA Tarjan algorithm
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Offline LCA Tarjan algorithm" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Offline LCA Tarjan algorithm
int main() {
    // Fast I/O
