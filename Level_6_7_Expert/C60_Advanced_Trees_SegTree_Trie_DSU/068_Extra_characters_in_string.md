# Chapter: Extra characters in string
...
**Topic:** Extra characters in string
...
**Key theorem/property for Extra characters in string:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Extra characters in string
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Extra characters in string" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Extra characters in string
int main() {
    // Fast I/O
