# Chapter: LCP array Kasai algorithm
...
**Topic:** LCP array Kasai algorithm
...
**Key theorem/property for LCP array Kasai algorithm:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: LCP array Kasai algorithm
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: LCP array Kasai algorithm" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: LCP array Kasai algorithm
int main() {
    // Fast I/O
