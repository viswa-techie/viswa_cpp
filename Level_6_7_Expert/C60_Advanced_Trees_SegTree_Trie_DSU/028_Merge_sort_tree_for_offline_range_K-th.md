# Chapter: Merge sort tree for offline range K-th
...
**Topic:** Merge sort tree for offline range K-th
...
**Key theorem/property for Merge sort tree for offline range K-th:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Merge sort tree for offline range K-th
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Merge sort tree for offline range K-th" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Merge sort tree for offline range K-th
int main() {
    // Fast I/O
