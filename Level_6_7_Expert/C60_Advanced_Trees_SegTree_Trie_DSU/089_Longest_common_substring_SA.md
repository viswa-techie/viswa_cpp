# Chapter: Longest common substring SA
...
**Topic:** Longest common substring SA
...
**Key theorem/property for Longest common substring SA:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Longest common substring SA
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Longest common substring SA" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Longest common substring SA
int main() {
    // Fast I/O
