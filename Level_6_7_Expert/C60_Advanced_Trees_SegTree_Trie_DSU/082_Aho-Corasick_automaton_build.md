# Chapter: Aho-Corasick automaton build
...
**Topic:** Aho-Corasick automaton build
...
**Key theorem/property for Aho-Corasick automaton build:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Aho-Corasick automaton build
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Aho-Corasick automaton build" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Aho-Corasick automaton build
int main() {
    // Fast I/O
