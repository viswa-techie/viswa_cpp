# Chapter: Segment tree for number of inversions
...
**Topic:** Segment tree for number of inversions
...
**Key theorem/property for Segment tree for number of inversions:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Segment tree for number of inversions
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Segment tree for number of inversions" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Segment tree for number of inversions
int main() {
    // Fast I/O
