# Chapter: Segment tree beats chmin chmax
...
**Topic:** Segment tree beats chmin chmax
...
**Key theorem/property for Segment tree beats chmin chmax:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Segment tree beats chmin chmax
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Segment tree beats chmin chmax" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Segment tree beats chmin chmax
int main() {
    // Fast I/O
