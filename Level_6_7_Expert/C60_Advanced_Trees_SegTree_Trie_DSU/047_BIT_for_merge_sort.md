...
**Key theorem/property for BIT for merge sort:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: BIT for merge sort
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: BIT for merge sort" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: BIT for merge sort
int main() {
    // Fast I/O
