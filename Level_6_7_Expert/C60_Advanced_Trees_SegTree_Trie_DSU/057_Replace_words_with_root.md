# Chapter: Replace words with root
...
**Key theorem/property for Replace words with root:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Replace words with root
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Replace words with root" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Replace words with root
int main() {
    // Fast I/O
