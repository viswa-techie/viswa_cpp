# Chapter: Lexicographically smallest subsequence
...
**Topic:** Lexicographically smallest subsequence
...
**Key theorem/property for Lexicographically smallest subsequence:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Lexicographically smallest subsequence
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Lexicographically smallest subsequence" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Lexicographically smallest subsequence
int main() {
    // Fast I/O
