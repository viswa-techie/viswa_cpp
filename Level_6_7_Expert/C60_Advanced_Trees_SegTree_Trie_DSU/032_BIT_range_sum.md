...
**Key theorem/property for BIT range sum:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: BIT range sum
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: BIT range sum" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: BIT range sum
int main() {
    // Fast I/O
