...
**Key theorem/property for SAM endpos sets:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: SAM endpos sets
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: SAM endpos sets" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: SAM endpos sets
int main() {
    // Fast I/O
