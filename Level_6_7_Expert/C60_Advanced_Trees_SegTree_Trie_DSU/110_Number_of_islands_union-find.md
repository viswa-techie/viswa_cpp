# Chapter: Number of islands union-find
...
**Topic:** Number of islands union-find
...
**Key theorem/property for Number of islands union-find:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Number of islands union-find
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Number of islands union-find" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Number of islands union-find
int main() {
    // Fast I/O
