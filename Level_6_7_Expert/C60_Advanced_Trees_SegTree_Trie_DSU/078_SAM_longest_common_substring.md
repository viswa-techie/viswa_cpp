# Chapter: SAM longest common substring
...
**Topic:** SAM longest common substring
...
**Key theorem/property for SAM longest common substring:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: SAM longest common substring
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: SAM longest common substring" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: SAM longest common substring
int main() {
    // Fast I/O
