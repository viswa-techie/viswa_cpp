# Chapter: Segment tree beats Ji driver
...
**Topic:** Segment tree beats Ji driver
...
**Key theorem/property for Segment tree beats Ji driver:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Segment tree beats Ji driver
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Segment tree beats Ji driver" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Segment tree beats Ji driver
int main() {
    // Fast I/O
