# Chapter: Smallest string with swaps
...
**Key theorem/property for Smallest string with swaps:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Smallest string with swaps
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Smallest string with swaps" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Smallest string with swaps
int main() {
    // Fast I/O
