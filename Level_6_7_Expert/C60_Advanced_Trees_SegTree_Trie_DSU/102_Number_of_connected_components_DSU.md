# Chapter: Number of connected components DSU
...
**Topic:** Number of connected components DSU
...
**Key theorem/property for Number of connected components DSU:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Number of connected components DSU
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Number of connected components DSU" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Number of connected components DSU
int main() {
    // Fast I/O
