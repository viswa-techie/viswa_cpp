# Chapter: Detect cycle union-find
...
**Key theorem/property for Detect cycle union-find:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Detect cycle union-find
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Detect cycle union-find" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Detect cycle union-find
int main() {
    // Fast I/O
