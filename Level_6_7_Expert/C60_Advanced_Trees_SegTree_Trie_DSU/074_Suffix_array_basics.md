...
**Key theorem/property for Suffix array basics:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Suffix array basics
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Suffix array basics" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Suffix array basics
int main() {
    // Fast I/O
