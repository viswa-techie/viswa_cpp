# Chapter: Segment tree on strings
...
**Key theorem/property for Segment tree on strings:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Segment tree on strings
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Segment tree on strings" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Segment tree on strings
int main() {
    // Fast I/O
