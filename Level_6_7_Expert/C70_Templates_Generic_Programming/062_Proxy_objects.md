...
**Key theorem/property for Proxy objects:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Proxy objects
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Proxy objects" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Proxy objects
int main() {
    // Fast I/O
