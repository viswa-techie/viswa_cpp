...
**Key theorem/property for Task coroutine type:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Task coroutine type
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Task coroutine type" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Task coroutine type
int main() {
    // Fast I/O
