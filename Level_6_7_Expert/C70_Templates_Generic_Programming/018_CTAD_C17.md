...
**Key theorem/property for CTAD C++17:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: CTAD C++17
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: CTAD C++17" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: CTAD C++17
int main() {
    // Fast I/O
