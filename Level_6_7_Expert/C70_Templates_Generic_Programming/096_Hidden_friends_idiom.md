...
**Key theorem/property for Hidden friends idiom:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Hidden friends idiom
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Hidden friends idiom" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Hidden friends idiom
int main() {
    // Fast I/O
