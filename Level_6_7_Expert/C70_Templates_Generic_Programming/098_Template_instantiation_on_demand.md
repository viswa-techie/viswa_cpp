# Chapter: Template instantiation on demand
...
**Topic:** Template instantiation on demand
...
**Key theorem/property for Template instantiation on demand:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Template instantiation on demand
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Template instantiation on demand" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Template instantiation on demand
int main() {
    // Fast I/O
