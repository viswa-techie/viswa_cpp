# Chapter: Coroutine promise type
...
**Key theorem/property for Coroutine promise type:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Coroutine promise type
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Coroutine promise type" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Coroutine promise type
int main() {
    // Fast I/O
