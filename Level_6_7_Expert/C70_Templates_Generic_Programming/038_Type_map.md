...
**Key theorem/property for Type map:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Type map
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Type map" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Type map
int main() {
    // Fast I/O
