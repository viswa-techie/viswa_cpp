# Chapter: Friend function template
...
**Topic:** Friend function template
...
**Key theorem/property for Friend function template:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Friend function template
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Friend function template" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Friend function template
int main() {
    // Fast I/O
