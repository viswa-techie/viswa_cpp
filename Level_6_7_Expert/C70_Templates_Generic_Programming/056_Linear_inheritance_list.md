# Chapter: Linear inheritance list
...
**Key theorem/property for Linear inheritance list:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Linear inheritance list
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Linear inheritance list" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Linear inheritance list
int main() {
    // Fast I/O
