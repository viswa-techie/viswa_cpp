# Chapter: Coroutine as template C++20
...
**Topic:** Coroutine as template C++20
...
**Key theorem/property for Coroutine as template C++20:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Coroutine as template C++20
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Coroutine as template C++20" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Coroutine as template C++20
int main() {
    // Fast I/O
