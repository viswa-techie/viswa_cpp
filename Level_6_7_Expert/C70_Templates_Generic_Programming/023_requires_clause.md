...
**Key theorem/property for requires clause:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: requires clause
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: requires clause" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: requires clause
int main() {
    // Fast I/O
