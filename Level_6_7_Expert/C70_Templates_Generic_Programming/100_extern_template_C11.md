...
**Key theorem/property for extern template C++11:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: extern template C++11
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: extern template C++11" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: extern template C++11
int main() {
    // Fast I/O
