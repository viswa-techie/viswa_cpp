...
**Key theorem/property for Type list:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Type list
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Type list" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Type list
int main() {
    // Fast I/O
