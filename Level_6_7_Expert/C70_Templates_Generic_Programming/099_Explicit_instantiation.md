# Chapter: Explicit instantiation
...
**Key theorem/property for Explicit instantiation:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Explicit instantiation
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Explicit instantiation" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Explicit instantiation
int main() {
    // Fast I/O
