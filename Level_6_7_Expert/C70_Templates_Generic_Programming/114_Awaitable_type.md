...
**Key theorem/property for Awaitable type:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Awaitable type
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Awaitable type" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Awaitable type
int main() {
    // Fast I/O
