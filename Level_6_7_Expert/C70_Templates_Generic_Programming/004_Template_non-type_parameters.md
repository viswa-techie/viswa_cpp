# Chapter: Template non-type parameters
...
**Topic:** Template non-type parameters
...
**Key theorem/property for Template non-type parameters:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Template non-type parameters
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Template non-type parameters" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Template non-type parameters
int main() {
    // Fast I/O
