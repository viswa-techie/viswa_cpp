...
**Key theorem/property for std overload pattern:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: std overload pattern
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: std overload pattern" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: std overload pattern
int main() {
    // Fast I/O
