...
**Key theorem/property for requires expression:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: requires expression
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: requires expression" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: requires expression
int main() {
    // Fast I/O
