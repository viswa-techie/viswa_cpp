# Chapter: CRTP for static polymorphism
...
**Topic:** CRTP for static polymorphism
...
**Key theorem/property for CRTP for static polymorphism:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: CRTP for static polymorphism
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: CRTP for static polymorphism" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: CRTP for static polymorphism
int main() {
    // Fast I/O
