...
**Key theorem/property for Substitution failure:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Substitution failure
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Substitution failure" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Substitution failure
int main() {
    // Fast I/O
