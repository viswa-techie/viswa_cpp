...
**Key theorem/property for Reflection via traits:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Reflection via traits
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Reflection via traits" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Reflection via traits
int main() {
    // Fast I/O
