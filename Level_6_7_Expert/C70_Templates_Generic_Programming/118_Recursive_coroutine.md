...
**Key theorem/property for Recursive coroutine:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Recursive coroutine
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Recursive coroutine" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Recursive coroutine
int main() {
    // Fast I/O
