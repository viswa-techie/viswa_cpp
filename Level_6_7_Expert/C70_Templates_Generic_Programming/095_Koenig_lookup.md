...
**Key theorem/property for Koenig lookup:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Koenig lookup
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Koenig lookup" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Koenig lookup
int main() {
    // Fast I/O
