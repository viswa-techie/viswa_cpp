...
**Key theorem/property for Chaining futures:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Chaining futures
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Chaining futures" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Chaining futures
int main() {
    // Fast I/O
