...
**Key theorem/property for std packaged_task:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: std packaged_task
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: std packaged_task" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: std packaged_task
int main() {
    // Fast I/O
