...
**Key theorem/property for std async:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: std async
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: std async" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: std async
int main() {
    // Fast I/O
