...
**Key theorem/property for OpenMP tasks:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: OpenMP tasks
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: OpenMP tasks" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: OpenMP tasks
int main() {
    // Fast I/O
