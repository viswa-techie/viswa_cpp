...
**Key theorem/property for NUMA awareness:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: NUMA awareness
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: NUMA awareness" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: NUMA awareness
int main() {
    // Fast I/O
