...
**Key theorem/property for Data race definition:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Data race definition
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Data race definition" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Data race definition
int main() {
    // Fast I/O
