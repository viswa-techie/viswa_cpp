...
**Key theorem/property for Happens-before relation:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Happens-before relation
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Happens-before relation" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Happens-before relation
int main() {
    // Fast I/O
