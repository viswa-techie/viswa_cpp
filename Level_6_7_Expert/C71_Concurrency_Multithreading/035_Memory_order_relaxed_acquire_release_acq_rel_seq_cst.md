# Chapter: Memory order relaxed acquire release acq_rel seq_cst
...
**Topic:** Memory order relaxed acquire release acq_rel seq_cst
...
**Key theorem/property for Memory order relaxed acquire release acq_rel seq_cst:**  
