...
**Key theorem/property for Helgrind Valgrind:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Helgrind Valgrind
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Helgrind Valgrind" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Helgrind Valgrind
int main() {
    // Fast I/O
