# Chapter: Bridges Tarjan low-link
...
**Key theorem/property for Bridges Tarjan low-link:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Bridges Tarjan low-link
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Bridges Tarjan low-link" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Bridges Tarjan low-link
int main() {
    // Fast I/O
