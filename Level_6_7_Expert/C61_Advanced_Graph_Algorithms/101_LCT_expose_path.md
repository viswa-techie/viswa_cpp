...
**Key theorem/property for LCT expose path:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: LCT expose path
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: LCT expose path" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: LCT expose path
int main() {
    // Fast I/O
