# Chapter: SSP Successive Shortest Paths
...
**Topic:** SSP Successive Shortest Paths
...
**Key theorem/property for SSP Successive Shortest Paths:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: SSP Successive Shortest Paths
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: SSP Successive Shortest Paths" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: SSP Successive Shortest Paths
int main() {
    // Fast I/O
