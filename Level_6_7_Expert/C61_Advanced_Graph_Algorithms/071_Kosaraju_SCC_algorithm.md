# Chapter: Kosaraju SCC algorithm
...
**Key theorem/property for Kosaraju SCC algorithm:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Kosaraju SCC algorithm
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Kosaraju SCC algorithm" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Kosaraju SCC algorithm
int main() {
    // Fast I/O
