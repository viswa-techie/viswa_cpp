# Chapter: Stable matching Gale-Shapley
...
**Topic:** Stable matching Gale-Shapley
...
**Key theorem/property for Stable matching Gale-Shapley:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Stable matching Gale-Shapley
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Stable matching Gale-Shapley" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Stable matching Gale-Shapley
int main() {
    // Fast I/O
