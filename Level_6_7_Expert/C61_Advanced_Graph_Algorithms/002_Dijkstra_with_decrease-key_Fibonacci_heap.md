# Chapter: Dijkstra with decrease-key Fibonacci heap
...
**Topic:** Dijkstra with decrease-key Fibonacci heap
...
**Key theorem/property for Dijkstra with decrease-key Fibonacci heap:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Dijkstra with decrease-key Fibonacci heap
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Dijkstra with decrease-key Fibonacci heap" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Dijkstra with decrease-key Fibonacci heap
int main() {
    // Fast I/O
