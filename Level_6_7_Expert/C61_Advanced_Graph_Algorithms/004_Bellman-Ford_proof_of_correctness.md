# Chapter: Bellman-Ford proof of correctness
...
**Topic:** Bellman-Ford proof of correctness
...
**Key theorem/property for Bellman-Ford proof of correctness:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Bellman-Ford proof of correctness
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Bellman-Ford proof of correctness" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Bellman-Ford proof of correctness
int main() {
    // Fast I/O
