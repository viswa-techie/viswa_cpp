...
**Key theorem/property for LCT aggregate on path:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: LCT aggregate on path
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: LCT aggregate on path" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: LCT aggregate on path
int main() {
    // Fast I/O
