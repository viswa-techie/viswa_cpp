...
**Key theorem/property for Tarjan SCC algorithm:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Tarjan SCC algorithm
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Tarjan SCC algorithm" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Tarjan SCC algorithm
int main() {
    // Fast I/O
