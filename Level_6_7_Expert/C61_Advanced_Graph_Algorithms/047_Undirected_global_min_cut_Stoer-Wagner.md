# Chapter: Undirected global min cut Stoer-Wagner
...
**Topic:** Undirected global min cut Stoer-Wagner
...
**Key theorem/property for Undirected global min cut Stoer-Wagner:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Undirected global min cut Stoer-Wagner
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Undirected global min cut Stoer-Wagner" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Undirected global min cut Stoer-Wagner
int main() {
    // Fast I/O
