# Chapter: Eulerian circuit Hierholzer algorithm
...
**Topic:** Eulerian circuit Hierholzer algorithm
...
**Key theorem/property for Eulerian circuit Hierholzer algorithm:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Eulerian circuit Hierholzer algorithm
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Eulerian circuit Hierholzer algorithm" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Eulerian circuit Hierholzer algorithm
int main() {
    // Fast I/O
