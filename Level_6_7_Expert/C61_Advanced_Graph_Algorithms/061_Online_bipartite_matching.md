# Chapter: Online bipartite matching
...
**Topic:** Online bipartite matching
...
**Key theorem/property for Online bipartite matching:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Online bipartite matching
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Online bipartite matching" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Online bipartite matching
int main() {
    // Fast I/O
