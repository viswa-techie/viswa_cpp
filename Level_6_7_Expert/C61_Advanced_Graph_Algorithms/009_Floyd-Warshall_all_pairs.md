# Chapter: Floyd-Warshall all pairs
...
**Topic:** Floyd-Warshall all pairs
...
**Key theorem/property for Floyd-Warshall all pairs:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Floyd-Warshall all pairs
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Floyd-Warshall all pairs" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Floyd-Warshall all pairs
int main() {
    // Fast I/O
