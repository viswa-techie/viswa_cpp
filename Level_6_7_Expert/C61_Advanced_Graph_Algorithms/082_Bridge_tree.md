...
**Key theorem/property for Bridge tree:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Bridge tree
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Bridge tree" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Bridge tree
int main() {
    // Fast I/O
