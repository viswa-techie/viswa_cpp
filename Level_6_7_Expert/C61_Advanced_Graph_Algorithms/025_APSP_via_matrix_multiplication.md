# Chapter: APSP via matrix multiplication
...
**Topic:** APSP via matrix multiplication
...
**Key theorem/property for APSP via matrix multiplication:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: APSP via matrix multiplication
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: APSP via matrix multiplication" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: APSP via matrix multiplication
int main() {
    // Fast I/O
