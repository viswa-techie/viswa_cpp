# Chapter: Small-to-large merging DSU on tree
...
**Topic:** Small-to-large merging DSU on tree
...
**Key theorem/property for Small-to-large merging DSU on tree:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Small-to-large merging DSU on tree
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Small-to-large merging DSU on tree" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Small-to-large merging DSU on tree
int main() {
    // Fast I/O
