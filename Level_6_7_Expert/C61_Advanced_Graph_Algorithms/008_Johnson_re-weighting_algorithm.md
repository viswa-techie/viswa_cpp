# Chapter: Johnson re-weighting algorithm
...
**Topic:** Johnson re-weighting algorithm
...
**Key theorem/property for Johnson re-weighting algorithm:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Johnson re-weighting algorithm
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Johnson re-weighting algorithm" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Johnson re-weighting algorithm
int main() {
    // Fast I/O
