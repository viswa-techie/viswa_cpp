...
**Key theorem/property for SCC condensation DAG:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: SCC condensation DAG
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: SCC condensation DAG" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: SCC condensation DAG
int main() {
    // Fast I/O
