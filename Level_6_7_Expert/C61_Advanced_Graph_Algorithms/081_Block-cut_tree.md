...
**Key theorem/property for Block-cut tree:**  
...
#include <iostream>
#include <vector>
// Production implementation template for: Block-cut tree
// TODO: Full implementation specific to this algorithm
int main() {
    std::cout << "Implementation: Block-cut tree" << std::endl;
    return 0;
}
```
...
#include <iostream>
#include <vector>
// Competitive/optimized version for: Block-cut tree
int main() {
    // Fast I/O
